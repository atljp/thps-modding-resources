...
script CUTSCENE_Ped_Stand_idles 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle1 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle2 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle3 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle4 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle5 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle6 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdle7 from = <FromTime>
    )
...
script CUTSCENE_Ped_Cheer_idles 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle1 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle2 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle3 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle4 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle5 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_CheerIdle6 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_Cheering 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Clap from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_ThumbUp from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheering from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer1 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer5 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer6 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer7 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_Sitting_idles 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_SittingIdle from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_SittingIdle2 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_SittingIdle3 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_Sitting_Cheers 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Sitting1 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Sitting2 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Sitting3 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Sitting4 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Sitting5 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_Kneeling_idles 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_KneelingIdle from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_KneelingIdle2 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_Kneeling_Cheers 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Kneeling1 fom = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Kneeling2 from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Cheer_Kneeling3 from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_SkaterPed_BoardStand_ildes 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdleA from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdleB from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdleC from = <FromTime>
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_SkateIdleD from = <FromTime>
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
...
script CUTSCENE_Ped_NO_Sit_idles 
    ...
    begin 
    Random (
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Sit_Idle_A from = <FromTime> Speed = 0.2500
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Sit_Idle_B from = <FromTime> Speed = 0.2500
        @ PlayAnimWithPartialAnimIfExists anim = Ped_M_Sit_Idle_C from = <FromTime> Speed = 0.2500
    )
    Obj_WaitAnimFinished
    FromTime = 0
    repeat 
