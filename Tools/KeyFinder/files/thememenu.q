...
script build_theme_sub_title parent = current_menu_anchor title_scale = 1.900 Pos = (0.0, 0.0) z_priority = 10 right_bracket_z = 1 right_bracket_alpha = 1.0
...
script make_new_themed_sub_menu dims = (300.0, 300.0) Pos = (215.0, 72.0) menu_id = sub_menu vmenu_id = sub_vmenu right_bracket_alpha = <right_bracket_alpha> right_bracket_z = 1
    if LevelIs load_mainmenu
