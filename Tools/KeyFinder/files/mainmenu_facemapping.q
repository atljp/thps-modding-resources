...
script exit_face_hsv 
    ...
    create_face_map_menu <...> focus_child = 7
endscript
...
script exit_face_skin 
    create_face_map_menu <...> focus_child = 8
endscript
...
script cancel_face_map 
    KillSpawnedScript name = get_face_points
    create_face_map_menu no_textures focus_child = 6
endscript
...
script get_face_points Scale = 2
    ...
    FormatText textname = directions 'Select %i\nusing the left analog stick and press \b3' i = (default_face_points [ <index> ].name)
    ...
    GetCurrentSkaterProfileIndex
    RefreshSkaterModel skater = 0 profile = <currentSkaterProfileIndex> no_board = no_board
    create_face_map_menu no_new_textures focus_child = 6
endscript
