...
script DJ_LoadingSounds 
    ...
    LoadSound 'Shared\Hits\HitWoodPlanks' vol = 100 dropoff = 50
    ...
    LoadSound 'Shared\Hits\Hitsign' vol = 100 dropoff = 50
    SetTerrainGrindWire
    SetTerrainWood
...
script DJ_SFX_CheeringCrowd 
endscript


script DJ_SFX_Generators 
endscript
