...
script AP_LoadingSounds 
    LoadSound 'Shared\Hits\HitPotty' vol = 100 dropoff = 0
    LoadSound 'shared\Hits\SmashWoodQP' vol = 100 dropoff = 0
    LoadSound 'Shared\Hits\HitFlag' vol = 100
    LoadSound 'VC\VC_HockeyBuzzer01' vol = 100 dropoff = 80
    LoadSound 'Shared\Hits\FallPungee_11' vol = 100 dropoff = 80
