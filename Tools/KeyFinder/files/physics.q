...
segway_physics = {
    ...
    Physics_Standing_Air_Friction = 0.00001000
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.000001000
    Skater_Max_Standing_Kick_Speed_Stat = {(300.0, 300.0) limit = 100 STATS_SPEED Switch = no_switch}
    Skater_Max_Crouched_Kick_Speed_Stat = {(1500.0, 1500.0) limit = 1500 STATS_SPEED Switch = no_switch}
    Physics_Standing_Acceleration_Stat = {(300.0, 300.0) STATS_SPEED Switch = no_switch}
    Physics_Crouching_Acceleration_stat = {(3000.0, 3000.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_default_head_height = 77
    Physics_Ground_Snap_Up = 24.20
    Physics_Air_Snap_Up = 15
    Physics_Ground_Snap_Down = 24.20
    Physics_Ground_Snap_Down_Skitching = 150.0
    Physics_Ground_Snap_up_Skitching = 50.0
    Skater_First_Forward_Collision_Height = 24.10
    Skater_First_Forward_Collision_Length = 10
    Skater_Min_Distance_To_Wall = 24.0
    Physics_Ground_Rotation = 4.0
    Physics_Ground_Sharp_Rotation = 5.0
    Physics_Air_No_Rotate_Time = 100
    Physics_Air_Ramp_Rotate_Time = 50
    spin_count_slop = 60
    Physics_Air_Gravity = -1350
    ...
    Physics_Air_Lean_stat = {(1.0, 1.0) STATS_SPIN Switch = no_switch}
    Physics_Air_Rotation_stat = {(7.0, 7.0) STATS_SPIN Switch = no_switch}
...
gurney_physics = {
    ...
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.00001000
    Skater_Max_Standing_Kick_Speed_Stat = {(100.0, 100.0) limit = 900 STATS_SPEED Switch = (0.800000011920929, 1.0)}
    Skater_Max_Crouched_Kick_Speed_Stat = {(500.0, 500.0) limit = 900 STATS_SPEED Switch = (0.800000011920929, 1.0)}
    Physics_Standing_Acceleration_Stat = {(200.0, 200.0) STATS_SPEED Switch = standard_switch}
    Physics_Crouching_Acceleration_stat = {(600.0, 600.0) STATS_SPEED Switch = standard_switch}
    Skater_Max_Speed_Stat = {(600.0, 600.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(600.0, 600.0) STATS_SPEED Switch = no_switch}
    Skater_default_head_height = 77
    Physics_Ground_Snap_Up = 13
    Physics_Air_Snap_Up = 15
    Physics_Ground_Snap_Down = 8.200
...
wheelchair_physics = {
    ...
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.000001000
    Skater_Max_Standing_Kick_Speed_Stat = {(600.0, 600.0) limit = 100 STATS_SPEED Switch = no_switch}
    Skater_Max_Crouched_Kick_Speed_Stat = {(1500.0, 1500.0) limit = 1500 STATS_SPEED Switch = no_switch}
    Physics_Standing_Acceleration_Stat = {(600.0, 600.0) STATS_SPEED Switch = no_switch}
    Physics_Crouching_Acceleration_stat = {(3000.0, 3000.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_default_head_height = 77
...
minikart_physics = {
    ...
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.000001000
    Skater_Max_Standing_Kick_Speed_Stat = {(500.0, 500.0) limit = 100 STATS_SPEED Switch = no_switch}
    Skater_Max_Crouched_Kick_Speed_Stat = {(500.0, 500.0) limit = 1500 STATS_SPEED Switch = no_switch}
    Physics_Standing_Acceleration_Stat = {(900.0, 900.0) STATS_SPEED Switch = no_switch}
    Physics_Crouching_Acceleration_stat = {(1000.0, 1000.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Speed_Stat = {(950.0, 950.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(1000.0, 1000.0) STATS_SPEED Switch = no_switch}
    ...
    Skater_Min_Distance_To_Wall = 24.0
    Physics_Ground_Rotation = 2.0
    Physics_Ground_Sharp_Rotation = 4.0
    Physics_Air_No_Rotate_Time = 100
    Physics_Air_Ramp_Rotate_Time = 50
    spin_count_slop = 60
    Physics_Air_Gravity = -1350
...
mechbull_physics = {
    ...
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.000001000
    Skater_Max_Standing_Kick_Speed_Stat = {(100.0, 100.0) limit = 100 STATS_SPEED Switch = no_switch}
    Skater_Max_Crouched_Kick_Speed_Stat = {(500.0, 500.0) limit = 1500 STATS_SPEED Switch = no_switch}
    Physics_Standing_Acceleration_Stat = {(300.0, 300.0) STATS_SPEED Switch = no_switch}
    Physics_Crouching_Acceleration_stat = {(1900.0, 1900.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(1800.0, 1800.0) STATS_SPEED Switch = no_switch}
    ...
    Skater_Min_Distance_To_Wall = 48.0
    Physics_Ground_Rotation = 2.0
    Physics_Ground_Sharp_Rotation = 4.0
    Physics_Air_No_Rotate_Time = 100
    Physics_Air_Ramp_Rotate_Time = 50
...
chainsaw_physics = {
    ...
    Physics_Crouched_Air_Friction = 0.000002000
    Physics_Rolling_Friction = 0.000001000
    Skater_Max_Standing_Kick_Speed_Stat = {(400.0, 400.0) limit = 100 STATS_SPEED Switch = no_switch}
    Skater_Max_Crouched_Kick_Speed_Stat = {(500.0, 500.0) limit = 1500 STATS_SPEED Switch = no_switch}
    Physics_Standing_Acceleration_Stat = {(900.0, 900.0) STATS_SPEED Switch = no_switch}
    Physics_Crouching_Acceleration_stat = {(1500.0, 1500.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Speed_Stat = {(750.0, 750.0) STATS_SPEED Switch = no_switch}
    Skater_Max_Max_Speed_Stat = {(2000.0, 2000.0) STATS_SPEED Switch = no_switch}
    Skater_default_head_height = 35
    Physics_Ground_Snap_Up = 13
    Physics_Air_Snap_Up = 15
    Physics_Ground_Snap_Down = 8.200
...
Physics_RunTimer_Duration = {(2.0, 3.0) STATS_RUN Switch = no_switch}
Hang_Run_Timer_Speed_Adjustment = 0.4000
focus_max_times_in_combo = 3
focus_time_limit = 15.0
focus_button_pressed_time = 100
Skater_Camera_Undefined = {horiz_fov = 0.0 , behind = 0.0 , above = 0.0 , tilt = 0.0 , slerp = 0.0 , vert_air_slerp = 0.0 , vert_air_landed_slerp = 0.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.0 , grind_zoom = 0.0 , origin_offset = 0.0 , wallride_offset_angle = 0.5000 , name = 'undefined'}
Skater_Camera_Standard_Medium = {horiz_fov = 72.0 , behind = 12.0 , above = 4.300 , tilt = 0.1800 , slerp = 0.04000 , vert_air_slerp = 0.04000 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.7000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard'}
Skater_Camera_Standard_Far = {horiz_fov = 72.0 , behind = 14.0 , above = 6.0 , tilt = 0.3000 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'far'}
Skater_Camera_Standard_Near = {horiz_fov = 72.0 , behind = 7.0 , above = 2.0 , tilt = 0.1800 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.9000 , lip_trick_zoom = 1.600 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'near'}
Skater_Camera_Standard_Medium_LTG = {horiz_fov = 72.0 , behind = 14.0 , above = 2.0 , tilt = 0.1500 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard ltg'}
Skater_Camera_2P_Vert_Medium = {horiz_fov = 72.0 , behind = 14.0 , above = 4.300 , tilt = 0.1800 , slerp = 0.04000 , vert_air_slerp = 0.04000 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.7000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard'}
Skater_Camera_2P_Vert_Far = {horiz_fov = 72.0 , behind = 22.0 , above = 6.0 , tilt = 0.3000 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'far'}
Skater_Camera_2P_Vert_Near = {horiz_fov = 72.0 , behind = 6 , above = 2.0 , tilt = 0.1800 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.9000 , lip_trick_zoom = 1.600 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'near'}
Skater_Camera_2P_Vert_Medium_LTG = {horiz_fov = 72.0 , behind = 14.0 , above = 3.0 , tilt = 0.1500 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard ltg'}
Skater_Camera_2P_Horiz_Medium = {horiz_fov = 72.0 , behind = 15.0 , above = 3.500 , tilt = 0.2000 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'far'}
Skater_Camera_2P_Horiz_Far = {horiz_fov = 72.0 , behind = 25.0 , above = 3.500 , tilt = 0.3000 , slerp = 0.04000 , vert_air_slerp = 0.04000 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.7000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard'}
Skater_Camera_2P_Horiz_Medium_LTG = {horiz_fov = 72.0 , behind = 15.0 , above = 3.0 , tilt = 0.1500 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 0.6000 , lip_trick_zoom = 1.0 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'standard ltg'}
Skater_Camera_2P_Horiz_Near = {horiz_fov = 72.0 , behind = 8.0 , above = 3.200 , tilt = 0.1800 , slerp = 0.08000 , vert_air_slerp = 0.02500 , vert_air_landed_slerp = 0.3750 , lerp_xz = 0.2500 , lerp_y = 0.7500 , vert_air_lerp_xz = 1.0 , vert_air_lerp_y = 1.0 , zoom_lerp = 0.06250 , big_air_trick_zoom = 1.0 , lip_trick_zoom = 1.600 , lip_trick_tilt = -0.8000 , lip_trick_above = 0.4000 , grind_zoom = 1.0 , origin_offset = 0.2000 , wallride_offset_angle = 0.5000 , name = 'near'}
...
walk_parameters = {
    ...
    drop_to_hang_rotate_factor = 0.5000
