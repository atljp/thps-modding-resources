...
goal_scavenger_genericParams = {
    goal_text = 'Sammle alle Objekte, um zu gewinnen!'
    time = 10
    net
    ...
    goal_description = 'Schnitzeljagd!'
}
...
script goal_scavenger_activate 
    ...
    FormatText textname = msg_text '\c2Schnitzeljagd:\c0\n\b7 + \b1, um Objekte zu platzieren!'
    msg_pos = (620.0, 27.0)
...
script goal_scavenger_add_time 
    create_net_panel_message \{ text = 'Du musst mindestens ein Objekt platzieren!' style = net_team_panel_message msg_time = 3000 }
