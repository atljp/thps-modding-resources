...
SubStateToEntryEventMapping = { flip = SkaterEnterFlip Grab = SkaterEnterGrab Transfer = SkaterEnterTransfer AcidDrop = SkaterEnterAcidDrop }
SubStateToExitEventMapping = { flip = SkaterExitFlip Grab = SkaterExitGrab Transfer = SkaterExitTransfer AcidDrop = SkaterExitAcidDrop }
...
script LaunchStateChangeEvent 
    newstate = <state>
    getsetoftags \{[ state StateExitEvent ]}
