...
script add_view_cutscenes_to_menu 
    ...
    make_select_view_cutscene_line text = 'HO_1A - The Beginning' name = 'cutscenes\HO_1A.cut'
    ...
    make_select_view_cutscene_line text = 'HO_2 - The New You' name = 'cutscenes\HO_2.cut'
    make_select_view_cutscene_line text = 'HO_3 - Sketchy Mc Sketch' name = 'cutscenes\HO_3.cut'
    make_select_view_cutscene_line text = 'BH_4 - Let me in' name = 'cutscenes\BH_4.cut'
    make_select_view_cutscene_line text = 'SR_5 - Intro to Iggy' name = 'cutscenes\SR_5.cut'
    make_select_view_cutscene_line text = 'SR_6a - Build That Ramp' name = 'cutscenes\SR_6a.cut'
    make_select_view_cutscene_line text = 'SR_6 - Ramp it up' name = 'cutscenes\SR_6.cut'
    ...
    make_select_view_cutscene_line text = 'SM_9 - Def-in-nate-ly' name = 'cutscenes\SM_9.cut'
    make_select_view_cutscene_line text = 'OR_10A - Megga' name = 'cutscenes\OR_10A.cut'
    make_select_view_cutscene_line text = 'HO_10B - Prizon Love' name = 'cutscenes\HO_10B.cut'
    make_select_view_cutscene_line text = 'BH_11a - Media Frenzy ' name = 'cutscenes\BH_11a.cut'
    make_select_view_cutscene_line text = 'BH_11 - Land Owner ' name = 'cutscenes\BH_11.cut'
    make_select_view_cutscene_line text = 'EL_12 - Make a Video' name = 'cutscenes\EL_12.cut'
    make_select_view_cutscene_line text = 'SR_13a - The End part one' name = 'cutscenes\SR_13a.cut'
    make_select_view_cutscene_line text = 'SR_13 - The End' name = 'cutscenes\SR_13.cut'
...
script create_view_cutscenes_menu 
    make_new_menu \{menu_id = view_cutscenes_menu vmenu_id = view_cutscenes_vmenu menu_title = 'CUTSCENES' type = vscrollingmenu dims = (320.0, 200.0) Pos = (500.0, 300.0)}
