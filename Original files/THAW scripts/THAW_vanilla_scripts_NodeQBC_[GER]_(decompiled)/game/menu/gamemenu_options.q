...
script create_options_menu 
    ...
    if NOT (DEMO_BUILD)
        if NOT InMultiPlayerGame
            if IsNGC
                switch camera_angle
                    case 0
                    camera_text = 'KAMERAWINKEL: 1'
                    case 1
                    camera_text = 'KAMERAWINKEL: 2'
                    case 2
                    camera_text = 'KAMERAWINKEL: 3'
                    case 3
                    camera_text = 'KAMERAWINKEL: 4'
                endswitch
                add_label_menu_item {
                    text = <camera_text>
                    rot = -2
    ...
    if NOT (DEMO_BUILD)
        if InNetGame
            ...
            FormatText textname = AutoBrake_toggle_text 'AUTO-BREMSE: %s' s = <ui_string>
            add_label_menu_item {
...
script toggle_camera_angle 
    switch camera_angle
        ...
        SetScreenElementProps id = { menu_camera child = 0 }text = 'KAMERAWINKEL: 2'
        ToggleSkaterCamMode skater = 0
        case 1
        change camera_angle = 2
        SetScreenElementProps id = { menu_camera child = 0 }text = 'KAMERAWINKEL: 3'
        ToggleSkaterCamMode skater = 0
        case 2
        change camera_angle = 3
        SetScreenElementProps id = { menu_camera child = 0 }text = 'KAMERAWINKEL: 4'
        ToggleSkaterCamMode skater = 0
        case 3
        change camera_angle = 0
        SetScreenElementProps id = { menu_camera child = 0 }text = 'KAMERAWINKEL: 1'
        ToggleSkaterCamMode skater = 0
    endswitch
endscript
...
script create_real_cheats_menu back_script = create_options_menu
    ...
    if InNetGame
        make_new_themed_scrolling_menu Title = 'ERWEITERTE OPTIONEN' dims = (600.0, 237.0) Pos = (229.0, 80.0) right_bracket_z = 1
    else
        make_new_themed_scrolling_menu Title = 'CHEATS' dims = (600.0, 237.0) Pos = (229.0, 80.0) right_bracket_z = 1
    endif
    ...
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_1
            make_cheats_menu_item text = 'Coole Specials' cheat_flag = CHEAT_COOL_SPECIAL_TRICKS pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if NOT InNetGame
    ...
    if GetGlobalFlag flag = CHEAT_UNLOCKED_10
        make_cheats_menu_item text = 'Flammen' cheat_flag = CHEAT_FLAME pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
    endif
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_12
            make_cheats_menu_item text = 'Immer Spezial' cheat_flag = cheat_always_special pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_13
            make_cheats_menu_item text = 'Perfektes Rail' cheat_flag = cheat_perfect_rail pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_14
            make_cheats_menu_item text = 'Perfekter Skitch' cheat_flag = cheat_perfect_skitch pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_16
            make_cheats_menu_item text = 'Perfekter Manual' cheat_flag = cheat_perfect_manual pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if NOT InNetGame
        if GetGlobalFlag flag = CHEAT_UNLOCKED_17
            make_cheats_menu_item text = 'Mondanziehung' cheat_flag = CHEAT_MOON pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript}
        endif
    endif
    if InNetGame
        if ishost
            make_cheats_menu_item text = 'Keine Reverts' cheat_flag = flag_g_expert_mode_no_reverts pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript reverse}
            make_cheats_menu_item text = 'Kein Gehen' cheat_flag = flag_g_expert_mode_no_walking pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript reverse}
            make_cheats_menu_item text = 'Keine Manuals' cheat_flag = flag_g_expert_mode_no_manuals pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript reverse}
            make_cheats_menu_item text = 'Keine Bal.-Anz.' cheat_flag = no_g_display_balance pad_choose_script = toggle_cheat pad_choose_params = {on_callback = NullScript off_callback = NullScript reverse}
        endif
    endif
    theme_menu_add_item text = 'Fertig' id = menu_done Scale = 1.0 pad_choose_script = <back_script> no_bg highlight_bar_scale = (2.799999952316284, 0.800000011920929)
...
script create_controller_config_menu 
    ...
    if GotParam controller_number
        if (<controller_number> = -1)
            FormatText textname = menu_title 'ALLGEMEIN' n = <controller_number>
        else
            FormatText textname = menu_title 'SPIELER %n' n = <controller_number>
        endif
        helper_text = {helper_text_elements = [{ text = '\b7/\b4 = Wählen' }
                { text = '\b6/\b5 = Anpassen' }
                { text = '\m1 = Zurück' }
                { text = '\m0 = OK' }
            ]
...
script control_change_values 
    ...
    if GotParam vibration
        ...
        if VibrationIsOn <player>
            VibrationOff <player>
            SetScreenElementProps {
                id = { menu_vibration child = extra_text }text = 'AUS'
            }
        else
            VibrationOn <player>
            SetScreenElementProps {
                id = { menu_vibration child = extra_text }text = 'EIN'
            }
    ...
    if GotParam autokick
        if AutokickIsOn <player>
            AutokickOff <player>
            SetScreenElementProps {
                id = { menu_autokick child = extra_text }text = 'AUS'
            }
        else
            AutokickOn <player>
            SetScreenElementProps {
                id = { menu_autokick child = extra_text }text = 'EIN'
            }
        endif
    endif
    if NOT IsNGC
        if GotParam spintaps
            if SpinTapsAreOn <player>
                SpinTapsOff <player>
                SetScreenElementProps {
                    id = { menu_spintaps child = extra_text }text = 'AUS'
                }
            else
                SpinTapsOn <player>
                SetScreenElementProps {
                    id = { menu_spintaps child = extra_text }text = 'EIN'
                }
            endif
        endif
    endif
...
script create_gamma_menu 
    ...
    theme_menu_add_item text = 'Rot: ' extra_text = <red_text> id = gamma_menu_red
    theme_menu_add_item text = 'Grün: ' extra_text = <green_text> id = gamma_menu_green
    theme_menu_add_item text = 'Blau: ' extra_text = <blue_text> id = gamma_menu_blue
    theme_menu_add_item text = 'Fertig' id = gamma_menu_done pad_choose_script = create_options_menu last_menu_item = last_menu_item
    SetScreenElementProps {
        id = gamma_menu_red
    ...
    create_helper_text {helper_text_elements = [{ text = '\b7/\b4=Wahl' }
            { text = '\b6/\b5=Position' }
            { text = '\m0=OK' }
            { text = '\m1=Zurück' }
        ]
...
script create_split_menu callback_script = create_options_menu
    ...
    make_new_themed_sub_menu Title = 'BILDANZEIGE' right_bracket_alpha = 0.0
    SetScreenElementProps {
        id = sub_menu
    ...
    theme_menu_add_item text = 'Vertikal' last_menu_item = 1 centered = centered pad_choose_script = generic_menu_pad_choose pad_choose_params = { <...> callback = split_setup_vertical }
    GoalManager_HideGoalPoints
    GoalManager_HidePoints
    finish_themed_sub_menu
endscript
    ...
    if IsPs2
        if NOT IsPAL
            add_label_menu_flag_item {
                ...
                text = 'PROGRESSIVE (VOLLBILD)-MODUS:'
                rot = 1
                padding = 40
...
script toggle_progressive_confirm 
    if NOT GetGlobalFlag flag = <flag>
        create_dialog_box {
            ...
            text = 'Wenn du in den Progressive (Vollbild)-Modus wechselst, wird das Bild möglicherweise nicht korrekt auf deinem Fernseher dargestellt. Warte in so einem Fall 15 Sekunden, bis der ursprüngliche Anzeigemodus wieder hergestellt wird. Fortfahren?'
            Pos = (320.0, 240.0)
            text_dims = (400.0, 0.0)
            just = [ center center ]
            ...
            text_scale = 1
            buttons = [
                {font = small text = 'Ja' pad_choose_script = yes_progressive_scan pad_choose_params = { callback_script = create_screen_menu }}
                {font = small text = 'Nein' pad_choose_script = no_progressive_scan pad_choose_params = { callback_script = create_screen_menu }}
            ]
        }
    else
...
script yes_progressive_scan 
    ...
    create_snazzy_dialog_box {
        Title = 'Progressive Scan'
        text = 'Der Progressive (480p) (Vollbild)-Modus wurde ausgewählt. Wähl JA, wenn du in diesem Modus fortfahren möchtest, oder NEIN, um zum normalen Interlaced-Modus zurückzukehren.'
        no_animate
        buttons = [
            {font = small text = 'Ja' pad_choose_script = progressive_done pad_choose_params = { callback_script = <callback_script> }}
            {font = small text = 'Nein' pad_choose_script = confirm_no_progressive pad_choose_params = { callback_script = <callback_script> }}
        ]
    }
...
script onload_progressive_scan_check callback_script = create_options_menu
    create_snazzy_dialog_box {
        Title = 'Progressive Scan'
        text = 'Du hast dich zuvor entschieden, dass die Darstellung des Spiels im Progressive (Vollbild)-Modus erfolgen soll. Dein Fernseher muss dazu Progressive Scan unterstützen. Möchtest du den Progressive (Vollbild)-Modus wieder aktivieren?'
        no_animate
        buttons = [
            {font = small text = 'Ja' pad_choose_script = yes_progressive_scan pad_choose_params = { callback_script = <callback_script> }}
            {font = small text = 'Nein' pad_choose_script = no_progressive_scan pad_choose_params = { callback_script = <callback_script> }}
        ]
    }
endscript
...
script confirm_no_progressive 
    ...
    create_snazzy_dialog_box {
        Title = 'Progressive Scan'
        text = 'Der Interlaced-Modus wurde wiederhergestellt.'
        no_animate
        buttons = [
            {font = small text = 'Weiter' pad_choose_script = progressive_done pad_choose_params = { callback_script = <callback_script> }}
        ]
    }
endscript
...
script toggle_auto_brake_option 
    ...
    if (<ui_string> = 'Aus')
        text = 'Ein'
        SetPreferencesFromUI prefs = network field = 'auto_brake' checksum = boolean_true string = 'Ein'
        SetScreenElementProps id = {<id> child = 0}text = 'AUTO-BREMSE: Ein'
    else
        text = 'Aus'
        SetPreferencesFromUI prefs = network field = 'auto_brake' checksum = boolean_false string = 'Aus'
        SetScreenElementProps id = {<id> child = 0}text = 'AUTO-BREMSE: Aus'
    endif
endscript
