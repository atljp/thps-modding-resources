...
script game_progress_menu_create 
    ...
    build_theme_sub_title Title = 'SPIELFORTSCHRITT'
    if InFrontend
    else
    endif
    CreateScreenElement {
    ...
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' STORY MODUS - MISSIONEN:' right_col_text = <goal_points>
    GetClassicLevelGoalCount
    FormatText textname = goal_points '%i / %j' i = <classic_total_goals> j = <classic_potential_goals>
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' ZIELE KLASSIK-MODUS:' right_col_text = <goal_points>
    progress_menu_add_item id1 = progress_vmenu seperator
    GetCompletionStatusText mode = GAME_COMPLETED_BEGINNER
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' STORY-MODUS - LEICHT:' right_col_text = <completion_status>
    GetCompletionStatusText mode = GAME_COMPLETED_NORMAL
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' STORY-MODUS - NORMAL:' right_col_text = <completion_status>
    GetCompletionStatusText mode = GAME_COMPLETED_SICK
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' STORY-MODUS - KRANK:' right_col_text = <completion_status>
    GetCompletionStatusText mode = GAME_COMPLETED_CLASSIC_NORMAL
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' KLASSIK-MODUS - NORMAL:' right_col_text = <completion_status>
    GetCompletionStatusText mode = GAME_COMPLETED_CLASSIC_SICK
    progress_menu_add_item id1 = progress_vmenu left_col_text = ' KLASSIK-MODUS - KRANK:' right_col_text = <completion_status>
    progress_menu_add_item id1 = progress_vmenu seperator
...
script GetCompletionStatusText 
    if (GetGlobalFlag flag = <mode>)
        ...
        <completion_status> = 'NICHT FERTIG'
    endif
