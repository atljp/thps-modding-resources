...
scalingmenu_arrow_scale = 0.7000
...
scalingmenu_constraints = [
    {part = object_scaling male_min = 90.0 male_max = 120.0 female_min = 90.0 female_max = 120.0}
    {part = headtop_bone_group male_min = 80.0 male_max = 130.0 female_min = 80.0 female_max = 130.0}
    {part = head_bone_group male_min = 85.0 male_max = 115.0 female_min = 85.0 female_max = 115.0}
    {part = nose_bone_group male_min = 20.0 male_max = 150.0 female_min = 20.0 female_max = 150.0}
    {part = Jaw_bone_group male_min = 60.0 male_max = 130.0 female_min = 60.0 female_max = 130.0}
    {part = torso_bone_group male_min = 90.0 male_max = 130.0 female_min = 90.0 female_max = 150.0}
    {part = stomach_bone_group male_min = 90.0 male_max = 130.0 female_min = 90.0 female_max = 100.0}
    {part = upper_arm_bone_group male_min = 90.0 male_max = 130.0 female_min = 90.0 female_max = 120.0}
    {part = lower_arm_bone_group male_min = 90.0 male_max = 130.0 female_min = 90.0 female_max = 120.0}
    {part = hands_bone_group male_min = 90.0 male_max = 130.0 female_min = 90.0 female_max = 120.0}
    {part = upper_leg_bone_group male_min = 90.0 male_max = 150.0 female_min = 90.0 female_max = 120.0}
    {part = lower_leg_bone_group male_min = 90.0 male_max = 150.0 female_min = 90.0 female_max = 120.0}
    {part = feet_bone_group male_min = 90.0 male_max = 150.0 female_min = 90.0 female_max = 120.0}
]
