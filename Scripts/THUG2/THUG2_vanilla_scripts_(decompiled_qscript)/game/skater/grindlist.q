...
Trick_360ShovitNoseGrind = { params = { Name = #"360 Shove-It NoseGrind" IsSpecial } Template = Template2 Prefix = "Trick_360ShovitNoseGrind2" specialanims = [ _360ShovitNoseGrind_Init , _360ShovitNoseGrind_range _360ShovitNoseGrind_out ] } 
Trick_Franklin_Grind = { params = { Name = #"Franklin Grind" IsSpecial UnlockFlag = SKATER_UNLOCKED_BENFRANKLIN } Template = Template2 Prefix = "Trick_Franklin_Grind2" specialanims = [ Special_FranklinGrind_Init , Special_FranklinGrind_Init Special_FranklinGrind_Out ] } 
...
Trick_Muska_Burn = { params = { Name = #"Muska 5-0 Flames" IsSpecial } Template = Template1 Prefix = "Trick_Muska_Burn" specialanims = [ Special_Muska_Burn_init , Special_Muska_Burn_range , Special_Muska_Burn_out ] } 
Trick_Worm = { params = { Name = #"Worm Grind" IsSpecial } Template = Template1 Prefix = "Trick_Worm" specialanims = [ Special_Muska_Worm_init , Special_Muska_Worm_idle , Special_Muska_Worm_out ] } 
Trick_TheBird = { params = { Name = #"The Bird" IsSpecial UnlockFlag = SKATER_UNLOCKED_HAND } Template = Template1 Prefix = "Trick_TheBird" specialanims = [ Special_Hand_TheBird_Init , Special_Hand_TheBird_Range , Special_Hand_TheBird_Out ] } 
Trick_BullF_Sword = { params = { Name = #"Espana Sword Slide" IsSpecial UnlockFlag = SKATER_UNLOCKED_BULLFIGHTER } Template = Template1 Prefix = "Trick_BullF_Sword" specialanims = [ Special_BullF_Sword_Init , Special_BullF_Sword_idle , Special_BullF_Sword_Out ] } 
Trick_Bam_Chainsaw = { params = { Name = #"Chainsaw Rocker Grind" IsSpecial } Template = Template1 Prefix = "Trick_Bam_Chainsaw" specialanims = [ Special_Bam_Chainsaw_Init , Special_Bam_Chainsaw_idle , Special_Bam_Chainsaw_Out ] } 
Trick_ShecklerPrimo = { params = { Name = #"Swimming with Sharks" IsSpecial UnlockFlag = SKATER_UNLOCKED_SHECKLER } Template = Template1 Prefix = "Trick_ShecklerPrimo" specialanims = [ Special_Sheckler_Primo_Init , Special_Sheckler_Primo_Range , Special_Sheckler_Primo_Out ] } 
Trick_WaxSlide = { params = { Name = #"Wax Slide" IsSpecial UnlockFlag = SKATER_UNLOCKED_SHREK } Template = Template1 Prefix = "Trick_WaxSlide" specialanims = [ Special_Shrek_Waxslide_Init , Special_Shrek_Waxslide_Range , Special_Shrek_Waxslide_Out ] } 
Trick_Hero = { params = { Name = #"Hero" IsSpecial UnlockFlag = SKATER_UNLOCKED_SOLDIER } Template = Template1 Prefix = "Trick_Hero" specialanims = [ Special_Soldier_AmerHero2_Init , Special_Soldier_AmerHero2_Idle , Special_Soldier_AmerHero2_Out ] } 
Trick_RockNRollSwitch = { params = { Name = #"Boardslide Bodyvarial" IsSpecial } Template = Template1 Prefix = "Trick_RockNRollSwitch" specialanims = [ Special_Bob_RockNRollSwitch_Init , Special_Bob_RockNRollSwitch_Idle , Special_Bob_RockNRollSwitch_Out ] } 
Trick_BiteBoard = { params = { Name = #"Bite Board" IsSpecial UnlockFlag = SKATER_UNLOCKED_STEVEO } Template = Template1 Prefix = "Trick_BiteBoard" specialanims = [ Special_SteveO_BiteBoard ] } 
GrindTricks = 
[ 
