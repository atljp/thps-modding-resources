...
SCRIPT Bail_Spin_CCW_Hard_C 
	GeneralBail { Anim1 = Bail_Spin_CCW_Hard_C NoBlending Endpose = Getup_HK_FT 
		IntoAirFrame = 1 Friction = 13.50000000000 SmackAnim = Bail_Wall_LT_Low 
...
SCRIPT Nutsac 
	GeneralBail { Anim1 = Nutsac NoBlending Endpose = Getup_HK_Lt 
		IntoAirFrame = 1 Friction = 20 SmackAnim = Bail_Wall_RT_Low 
		BoardOffFrame = 43 BoardVel = VECTOR(0.00000000000, 50.00000000000, 0.00000000000) BoardRotVel = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) BoardSkaterVel = 1 
...
SCRIPT startskate 
	...
	IF ControllerPressed down 
		printf "User Braking" 
		PlayAnim Anim = GetUp_S_NoPushOff Blendperiod = 0.10000000149 
		rolling_Fr = 100 
		EnablePlayerInput 
		gotoBrake = gotoBrake 
	ELSE 
