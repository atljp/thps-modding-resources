...
player1_horsecolor = [ 
	{ VECTOR(128.00000000000, 32.00000000000, 32.00000000000) alpha = 128 } 
] 
player2_horsecolor = [ 
	{ VECTOR(32.00000000000, 32.00000000000, 128.00000000000) alpha = 128 } 
] 
...
SCRIPT create_horse_panel_message 
	...
	SWITCH <id> 
		...
		DEFAULT 
	ENDSWITCH 
	create_panel_block <...> style = <style> parent = root_window pos = <message_pos> rgba = <message_color> dims = PAIR(450.00000000000, 0.00000000000) z_priority = 10 
ENDSCRIPT
