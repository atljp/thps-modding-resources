...
SCRIPT create_ctf_panel_message 
	create_panel_block id = current_ctf_message parent = root_window text = <msg_text> style = panel_message_goal final_pos = PAIR(620.00000000000, 80.00000000000) dont_animate 
ENDSCRIPT
