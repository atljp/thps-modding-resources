...
SCRIPT load_multiplayer_textures_to_main_memory 
	...
	IF GotParam unload 
		printf "!!! load_multiplayer_textures_to_main_memory unload" 
	ELSE 
		printf "!!! load_multiplayer_textures_to_main_memory" 
	ENDIF 
	textures = [ 
...
SCRIPT load_select_skater_textures_to_main_memory 
	pre_file = "MainmenuSprites.pre" 
	IF GotParam unload 
		printf "load_select_skater_textures_to_main_memory unload" 
	ELSE 
		printf "load_select_skater_textures_to_main_memory" 
	ENDIF 
	textures = [ 
...
SCRIPT load_cag_textures_to_main_memory 
	...
	IF GotParam unload 
		printf "load_cag_textures_to_main_memory unload" 
	ELSE 
		printf "load_cag_textures_to_main_memory" 
	ENDIF 
...
SCRIPT load_cag_premade_to_main_memory 
	...
	IF GotParam unload 
		printf "load_cag_premade_to_main_memory unload" 
	ELSE 
		printf "load_cag_premade_to_main_memory" 
	ENDIF 
...
SCRIPT load_skater_stickers_to_main_memory 
	...
	IF GotParam unload 
		...
		ELSE 
			...
			printf "load_skater_stickers_to_main_memory unload" 
		ENDIF 
	ELSE 
		...
		ELSE 
			...
			printf "load_skater_stickers_to_main_memory" 
		ENDIF 
	ENDIF 
	IF GlobalExists name = edit_graphics_graphics type = array 
