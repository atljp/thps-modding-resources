...
SCRIPT screen_outline rgba = [ 128 128 128 128 ] 
	IF isps2 
		...
		CreateScreenElement { 
			...
			texture = white2 
			scale = PAIR(0.15000000596, 51.00000000000) 
			pos = PAIR(18.00000000000, 22.00000000000) 
			rgba = <rgba> 
			just = [ left top ] 
		} 
		CreateScreenElement { 
			...
			texture = white2 
			scale = PAIR(0.15000000596, 51.00000000000) 
			pos = PAIR(620.00000000000, 22.00000000000) 
			rgba = <rgba> 
			just = [ left top ] 
		} 
		CreateScreenElement { 
			...
			parent = outline_anchor 
			texture = white2 
			scale = PAIR(75.00000000000, 0.15000000596) 
			pos = PAIR(20.00000000000, 20.00000000000) 
			rgba = <rgba> 
			just = [ left top ] 
		} 
		CreateScreenElement { 
			...
			texture = white2 
			scale = PAIR(75.00000000000, 0.15000000596) 
			pos = PAIR(20.00000000000, 430.00000000000) 
			rgba = <rgba> 
			just = [ left top ] 
		} 
	ENDIF 
