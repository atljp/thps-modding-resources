...
[ 
	{ 
		Pos = VECTOR(1.46626996994, 9.97067642212, 0.00000000000) 
...
ncomp_PedAI_default = { 
	...
	PedType = Skate 
	Priority = Normal 
	ContinueWeight = 1.00000000000 
	AdjustSpeedPercent = 50.00000000000 
	Acceleration = 500.00000000000 
	SkateAction = Continue 
	JumpHeight = 60.00000000000 
} 
ncomp_proxim_box = { 
	Class = ProximNode 
	Type = Camera 
