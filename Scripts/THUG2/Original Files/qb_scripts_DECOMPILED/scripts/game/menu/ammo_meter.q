...
SCRIPT create_ammo_meter 
	...
	ELSE 
		id = 1 
	ENDIF 
	pos = PAIR(145.00000000000, 45.00000000000) 
	scale = PAIR(0.82999998331, 1.17999994755) 
	...
	CreateScreenElement { 
		...
		text = "0" 
		font = testtitle 
		pos = ( <width> * PAIR(0.62000000477, 0.00000000000) + <height> * PAIR(0.00000000000, 0.50000000000) ) 
		just = [ center center ] 
		scale = 0.89999997616 
		rgba = [ 128 128 128 128 ] 
	} 
