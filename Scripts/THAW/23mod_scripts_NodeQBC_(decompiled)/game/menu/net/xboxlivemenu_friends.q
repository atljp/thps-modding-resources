...
script xboxlive_menu_recent_players_separator_add 
    xboxlive_menu_friends_separator_add \{ text = 'Ostatni Gracze' }
endscript
...
script xbox360_live_not_allowed 
    create_error_box \{Title = 'Xbox Live' text = 'Nie masz pozwolenia na dostêp do us³ugi Xbox Live' buttons = [{ text = 'OK' pad_choose_script = launch_main_menu }] no_animate delay_input}
endscript
