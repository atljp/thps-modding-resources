...
script toggle_special_sounds 
    if NOT GetGlobalFlag \{ flag = SOUNDS_SPECIALSOUNDS_OFF }
        ...
        SetScreenElementProps \{id = { menu_sound_special child = extra_text }text = 'OFF'}
    else
        UnsetGlobalFlag \{ flag = SOUNDS_SPECIALSOUNDS_OFF }
        playsound \{ HUD_specialtrickAA }
        SetScreenElementProps \{id = { menu_sound_special child = extra_text }text = 'ON'}
    endif
endscript
...
script toggle_music_zones 
    if NOT GetGlobalFlag \{ flag = SOUNDS_MUSICBOXES_OFF }
        ...
        SetScreenElementProps \{id = { menu_sound_zones child = extra_text }text = 'OFF'}
    else
        UnsetGlobalFlag \{ flag = SOUNDS_MUSICBOXES_OFF }
        SetScreenElementProps \{id = { menu_sound_zones child = extra_text }text = 'ON'}
    endif
    if NOT InFrontend
