...
script create_pro_model_set 
    ...
    make_select_view_model_line text = 'Koniczyna' profile = mv_Ped_Clover animLoadScript = animload_THPS7_Human SkeletonName = thps7_human defaultanim = Ped_M_Idle1 SkeletonName = thps7_human
