...
script level_select_created_park_menu 
    ...
    if GotParam from_server_options
        created_park_menu_add_item {text = 'Zagraj w tym parku'
    ...
    if GotParam from_server_options
        created_park_menu_add_item {text = 'Wczytaj park'
    ...
    if GotParam from_server_options
        created_park_menu_add_item {text = 'Prekonstruowane parki'
    ...
    created_park_menu_add_item {text = 'wstecz'
    ...
    if GotParam from_server_options
        ...
        if IsParkUnsaved
            menu_confirm_quit {yes_script = launch_level_select_load_park_sequence
                Title = 'Zast¹piæ niezapisany park?'
                text_dims = (330.0, 0.0)
...
script level_select_created_park_list 
    ...
    if GotParam in_park_editor
        make_new_themed_scrolling_menu Title = 'GOTOWE PARKI'
    else
        make_new_skateshop_menu {
            parent = <parent>
    ...
    if GotParam in_park_editor
        theme_menu_add_item text = 'Zrobione' id = menu_done Scale = 1.0 pad_choose_script = create_pause_menu no_bg highlight_bar_scale = (1.7000000476837158, 0.800000011920929)
...
premade_parks_info = [
    { name = 'Ch³odno' slot = 1 max = 8 }
    { name = 'Ji Land 5' slot = 2 max = 8 }
    { name = 'Kariera' slot = 3 max = 8 }
    { name = 'Montana' slot = 4 max = 8 }
    { name = 'Hustle Drop' slot = 5 max = 8 exclude_ngc }
    { name = 'Którêdy' slot = 6 max = 8 }
    { name = 'Lodowato' slot = 7 max = 8 }
    { name = 'NSIT' slot = 8 max = 8 exclude_ngc }
    { name = 'Uwaga na lukê' slot = 9 max = 8 }
]
