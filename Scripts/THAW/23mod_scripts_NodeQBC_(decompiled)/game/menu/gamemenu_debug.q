...
script create_debug_menu 
    ...
    add_roundbar_menu_item rot = 0 text = 'Zrobione' id = menu_done pad_choose_script = create_debug_options_menu
...
script create_test_menu 
    ...
    make_text_sub_menu_item text = 'Klawiatura' pad_choose_script = launch_keyboard
    make_text_sub_menu_item text = 'Zrobione' id = menu_done pad_choose_script = create_debug_options_menu
    RunScriptOnScreenElement id = current_menu_anchor animate_in params = { final_pos = (320.0, 134.0) }
endscript
...
script modifylightcountdisplay 
    switch <light_type>
        case Model
        <text_id> = mlight_text
        FormatText textname = text 'wiat³a modeli: %d/%e' e = <count> d = <active>
        case geom
        <text_id> = glight_text
        FormatText textname = text 'wiat³a geometrii: %d/%e' e = <count> d = <active>
        case active
        <text_id> = alight_text
        FormatText textname = text 'wiat³a'
    endswitch
...
script launch_transition_speed_menu 
    ...
    make_new_menu {
        ...
        menu_title = 'szybkoæ przenikania'
        helper_text = generic_helper_text_left_right
    }
    make_text_sub_menu_item {
        text = '500'
