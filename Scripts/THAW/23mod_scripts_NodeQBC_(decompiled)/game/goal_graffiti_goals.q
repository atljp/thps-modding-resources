    ...
    if NOT InSplitScreenGame
        if GameModeEquals is_career
            ...
            AddGoal_Gaps {
                zone = <zone>
                version = <version>
                goal_text = 'Zataguj t¹ miejscówkê! (\b0)'
                goal_description = 'Zataguj t¹ miejscówkê! (\b0)'
                view_goals_text = 'Zataguj t¹ miejscówkê! (\b0)'
                goal_flags = [ got_1 ]
...
script graffiti_goals_edit_IGCs 
    graffiti_challenge = [
        {
            text = 'Pomó¿ mi pomalowaæ t¹ miejscówkê.'
            stream = graffiti_challenge_0_lip
        }
        {
            text = 'Pomó¿ mi zbombiæ to miejsce.'
            stream = graffiti_challenge_2_lip
        }
    ]
    graffiti_success = [
        {
            text = 'Niez³a robota, bracie! Ja znikam. Wpadaj do mnie, jak bêdziesz chcia³ znowu co razem pomalowaæ.'
            stream = graffiti_success_0_lip
        }
        {
            text = 'Dobra robota, Holmesie! Odszukaj mnie jak bêdziesz chcia³ wysadziæ co jeszcze. Mo¿na mnie spotkaæ prawie wszêdzie. Nara.'
            stream = graffiti_success_1_lip
        }
        {
            text = 'Niele! Wpadnij kiedy indziej, to znów pomalujemy razem. Pokój!'
    ...
    change graffiti_goals_intro_IGC = {
        ...
        shot_params = [
            ...
            }
            {
                ...
                text = 'Mylisz, ¿e mo¿esz dorzuciæ moj¹ czêæ a¿ tam? (\b0)'
                shot_script = goals_handlestream
...
script graffiti_goals_edit_pre_IGC 
    ...
    if (<firsttime> = 1)
        <igc_text_0> = 'Nazywam siê Muton. Wiesz, ¿e mo¿esz tagowaæ (\b0) ciany? Mo¿esz to zrobiæ wisz¹c ze ciany, albo stoj¹c na ziemi.'
    ...
    if (<firsttime> = 1)
        <igc_text_1> = 'U mnie mo¿esz stworzyæ w³asn¹ grafikê, a jak pomo¿esz mi dokoñczyæ moje tagi, to poka¿ê ci nowe style.'
        <igc_shot_script_stream_1> = graffiti_intro_lip
    else
        if (graffiti_goals_areacomplete = 1)
            graffiti_areacomplete = [
                {
                    text = 'Yo, pokaza³em ci ju¿ wszystkie moje style, wiêc popracuj nad w³asnym, albo poszukaj mnie w innej czêci miasta, gdzie bêdê ci móg³ pomóc jeszcze trochê.'
                    stream = graffiti_areacomplete_0_lip
                }
                {
                    text = 'Przekaza³em ci wszystkie style, których mo¿esz u¿ywaæ, wiêc albo dopracuj swój, albo znajd mnie w innej czêci miasta, to ci jeszcze pomogê.'
                    stream = graffiti_areacomplete_1_lip
                }
                {
                    text = 'Brachu, znasz ju¿ wszystkie style, których mo¿na tu u¿ywaæ. Popracuj nad w³asnym lub odszukaj mnie w innej czêci miasta, a wyklarujê ci to i owo.'
            ...
            graffiti_choice = [
                {
                    text = 'Co chcesz robiæ, pomóc wysadzaæ, czy zajmowaæ siê swoimi sprawami?'
                    stream = graffiti_choice_0_lip
                }
                {
                    text = 'Co bêdzie? Pomo¿esz mi czy zajmiesz siê w³asn¹ sztuk¹?'
                    stream = graffiti_choice_1_lip
                }
                {
                    text = 'Co zrobisz, brachu? Pomo¿esz mi czy zajmiesz siê w³asn¹ robot¹?'
