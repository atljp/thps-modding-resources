...
master_editable_list = [
    ...
    { part = ped_board use_pedpre }
    {
        ...
        pass = 0
        colormenu = wheel_color_menu
    }
    {
        part = ped_m_accessories
        submenu = #"0x2b0d8fc7"
        Male = 1
        Female = 1
        colormenu = #"0xf4bd4b04"
    }
    {
        part = ped_head
        submenu = #"0xad99fd69"
        Male = 1
        Female = 1
        colormenu = #"0xb9c47b7c"
    }
    {
        part = Ped_M_Busi_accessories
        submenu = #"0x66c52ecc"
        Male = 1
        Female = 1
        colormenu = #"0xf2000ff1"
    }
    {
        part = anl_body
        submenu = #"0x7bc01e74"
    ...
    { part = skater_m_lower_legs Male = 1 Female = 0 }
    {
        ...
        Female = 0
        submenu = hair_menu
        colormenu = hair_color_menu
    }
    {
        part = skater_m_hat_hair
        Male = 1
        Female = 0
        submenu = hat_hair_menu
        colormenu = hat_hair_color_menu
    }
    {
        part = skater_m_backpack
        Male = 1
        Female = 0
        submenu = backpack_menu
        colormenu = pack_color_menu
    }
    {
        part = skater_m_hands
        Male = 1
        Female = 0
        submenu = hands_menu
        colormenu = hands_color_menu
    }
    {
        part = skater_m_jaw
        material = skater_head
        pass = 2
        Male = 1
        Female = 0
        submenu = jaw_menu
        colormenu = facial_hair_color_menu
    }
    {
        part = skater_f_head
        Male = 0
    ...
    { part = bare_torso Male = 1 Female = 1 }
    {
        part = sleeves
        material = tshirt_sleeve
        pass = 0
        Male = 1
        Female = 1
        colormenu = sleeve_color_menu
    }
    {
        part = kneepads
        Male = 1
    ...
    }
    {
        ...
        colormenu = elbowpads_color_menu
    }
    {
        part = shoes
        materials = [
        ...
        Female = 1
        submenu = shoes_menu
        colormenu = shoe_color_menu
    }
    {
        part = shoe_laces
        material = Shoes_Laces
        pass = 0
        Male = 1
        Female = 1
        colormenu = shoe_laces_color_menu
    }
    {
        part = socks
        Male = 1
    ...
    { part = Eyes Male = 1 Female = 1 submenu = eyes_menu }
    {
        ...
        colormenu = accessory1_color_menu
        accessory_lists = [ 2 3 ]
    }
    {
        part = accessory2
        ...
        colormenu = accessory2_color_menu
        accessory_lists = [ 1 3 ]
    }
    {
        part = accessory3
        ...
        colormenu = accessory3_color_menu
        accessory_lists = [ 1 2 ]
    }
    ...
    { part = deck_graphic Male = 1 Female = 1 submenu = deck_graphic_menu }
    {
        ...
        posmenu = head_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = left_sleeve_tattoo
        Male = 1
        Female = 1
    ...
    {
        part = left_bicep_tattoo
        Male = 1
        Female = 1
        submenu = left_bicep_tattoo_menu
        posmenu = left_bicep_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = left_forearm_tattoo
        Male = 1
        Female = 1
        submenu = left_forearm_tattoo_menu
        posmenu = left_forearm_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = right_sleeve_tattoo
        Male = 1
        Female = 1
    ...
    {
        part = right_bicep_tattoo
        Male = 1
        Female = 1
        submenu = right_bicep_tattoo_menu
        posmenu = right_bicep_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = right_forearm_tattoo
        Male = 1
        Female = 1
        submenu = right_forearm_tattoo_menu
        posmenu = right_forearm_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = chest_tattoo
    ...
    }
    {
        ...
        posmenu = back_tattoo_pos_menu
        is_tattoo = 1
    }
    {
        part = left_leg_tattoo
        Male = 1
        Female = 1
        submenu = left_leg_tattoo_menu
        posmenu = left_leg_tattoo_pos_menu
        is_tattoo = 1
        no_rot = 1
    }
    {
        part = right_leg_tattoo
        Male = 1
        Female = 1
        submenu = right_leg_tattoo_menu
        posmenu = right_leg_tattoo_pos_menu
        is_tattoo = 1
        no_rot = 1
    }
]
...
master_uv_list = [
    ...
    { part = head_tattoo material = skater_head pass = 1 }
    ...
    { part = left_leg_tattoo material = skater_Legs pass = 2 }
    { part = right_leg_tattoo material = skater_Legs pass = 1 }
]
headtop_bone_group = [ Bone_Head_Top_Scale ]
jaw_bone_group = [ Bone_Chin_Scale ]
nose_bone_group = [ Bone_Nose_Scale ]
head_bone_group = [ Bone_Head ]
stomach_bone_group = [
    Bone_Pelvis
    Bone_Stomach_Upper
    Bone_Stomach_Lower
...
torso_bone_group = [ Bone_Collar_L Bone_Collar_R Bone_Chest Cloth_Breast ]
upper_arm_bone_group = [ Bone_Bicep_L Bone_Bicep_R ]
lower_arm_bone_group = [ Bone_Forearm_L Bone_Wrist_L Bone_Forearm_R Bone_Wrist_R ]
hands_bone_group = [
    Bone_Palm_L
    Bone_Thumb_L
...
upper_leg_bone_group = [ Bone_Thigh_L Bone_Thigh_R ]
lower_leg_bone_group = [ Bone_Knee_L Bone_Knee_R ]
feet_bone_group = [
    Bone_Ankle_L
    Bone_Toe_L
    Bone_Ankle_R
