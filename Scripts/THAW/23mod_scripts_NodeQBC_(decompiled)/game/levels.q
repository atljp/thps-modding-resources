...
script mission_init 
    ...
    if StructureContains structure = <zone_structure> goals_script
        if NOT ScriptExists (<zone_structure>.goals_script)
            script_assert 'goals_script zdefinoiwany dla tego poziomu nie istnieje'
        endif
        PushMemProfile 'Skrypt zadañ'
