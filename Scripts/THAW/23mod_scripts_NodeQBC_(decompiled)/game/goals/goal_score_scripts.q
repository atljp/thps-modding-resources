Goal_GenericScore_genericParams = {
    goal_text = 'Zdob¹d amatorski wynik: 15.000 punktów'
    view_goals_text = 'Amatorski wynik'
    init = Score_init
    uninit = goal_uninit
    ...
    win_message_text = 'Zdobyto amatorski wynik!'
    record_type = time
    score_goal
}
...
Goal_ProScore_GenericParams = {
    goal_text = 'Zdob¹d profesjonalny wynik: 20.000 punktów'
    view_goals_text = 'Profesjonalny wynik'
    init = Score_init
    uninit = goal_uninit
    activate = Score_activate
    deactivate = Score_Deactivate
    ...
    time = 120
    already_displayed_win_message = 0
    win_message_text = 'Profesjonalny wynik: Sukces!'
    record_type = time
    score_goal
}
...
Goal_SickScore_GenericParams = {
    goal_text = 'Zdob¹d chory wynik: 30.000 punktów'
    view_goals_text = 'Chory wynik'
    init = Score_init
    uninit = goal_uninit
    activate = Score_activate
    deactivate = Score_Deactivate
    ...
    time = 120
    already_displayed_win_message = 0
    win_message_text = 'Chory wynik: Sukces!'
    record_type = time
    score_goal
}
...
script Score_success 
    ...
    if GotParam \{ winning_score }
        FormatText textname = text 'Wynik: %i' i = <winning_score>
