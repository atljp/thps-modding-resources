Goal_TimedScoreRun_GenericParams = {
    goal_text = 'Bieg po wynik'
    view_goals_text = 'Standardowy tekst \'przejazdu o rekord\''
...
script goal_timed_score_run_activate 
    ...
    if GameModeEquals is_career
        scriptassert 'Bieg po wynik aktywny w trybie kariery?'
    endif
...
script goal_timed_score_run_trigger 
    setup_ped_speech {
        ...
        display_name = 'Spróbuj pobiæ rekord'
