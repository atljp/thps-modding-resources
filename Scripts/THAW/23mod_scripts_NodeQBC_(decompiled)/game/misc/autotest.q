...
script TestSkateLettersGoal 
    DisplayTestMessage text = 'Zaczynam testowanie zadania typu \'literki\' ...'
    ...
    if GoalManager_ActivateGoal name = <goal_id> dontassert
        ...
        wait 1 seconds
        DisplayTestMessage text = 'Nie ma zadania z literami SKATE, które mo¿na by³oby przetestowaæ...'
    endif
endscript

script TestRaceGoal 
    DisplayTestMessage text = 'Zaczynam testowanie zadania typu \'wycig\'...'
    ...
    if GoalManager_ActivateGoal name = <goal_id> dontassert
        ...
        wait 1 seconds
        DisplayTestMessage text = 'Brak celu wycigu do przetestowania...'
    endif
endscript

script TestCollectGoal 
    DisplayTestMessage text = 'Testujê cel zbierania...'
    ...
    if GoalManager_ActivateGoal name = <goal_id> dontassert
        ...
        wait 1 seconds
        DisplayTestMessage text = 'Brak celu zbierania do przetestowania...'
    endif
endscript

script TestComboGoal 
    FormatText textname = MessageText 'Zaczynam testowanie %s ...' s = <type>
    ...
    if GoalManager_ActivateGoal name = <goal_id> dontassert
        ...
        wait 1 seconds
        FormatText textname = MessageText 'Brak %s do przetestowania...' s = <type>
        DisplayTestMessage text = <MessageText>
    endif
endscript
