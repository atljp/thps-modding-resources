                            ...
                            if driving
                                ...
                                create_panel_message {
                                    ...
                                    text = Random (
                                        ...
                                        @ 'ShoGun Ciê zbi³.'
                                        @ 'Epic FAIL.'
                                        @ 'Ja s³ysza³em ¿e ty czeszesz siê schabowym!'
                                        @ 'Roadkill.'
                                        @ 'Teren prywatny - Skejt23'
                                        @ 'Wdep³e w gówno.'
                                        @ 'Podpal Watykan!'
                                        @ 'Niech watykan p³onie!'
                                        @ 'Pierdol studia, zostañ Ninja!'
                                        @ 'Poza terenem!'
                                    )
                                }
                            endif
                    ...
                    if GotParam Message1
                        ...
                        create_panel_message {
                            ...
                            text = Random (
                                ...
                                @ 'Zakaz p³ywania'
                                @ 'Topisz siê!'
                                @ 'ShoGun zepchn¹³ ciê do wody!'
                                @ 'Haha top siê gówniarzu!'
                                @ 'Hej! Ta woda to szambo!'
                                @ 'Jeste zalany!'
                            )
                        }
                    endif
            ...
            if NOT GotParam Lava
                ...
                create_panel_message {
                    ...
                    text = Random (
                        @ 'Przypalone stópki!'
                        @ 'Spalony na chrupko!'
                        @ 'Idealnie przypieczony!'
                        @ 'Auæ!'
                        @ 'mieræ we wrz¹cej lawie!'
                    )
                }
            endif
        endif
...
script TeleportSkaterToNode r = 255 g = 255 b = 255
    if GotParam Message1
        ...
        LaunchPanelMessage properties = panel_message_death 'Ucieka!'
    endif
    GetSkaterHeight
...
script Team_Flag_Trigger 
    if NOT GetCurrentZoneName
        script_assert 'Team_Flag_Trigger wezwany zanim stworzono mapê strefy'
    endif
...
script kill_team_flags 
    if NOT GetCurrentZoneName
        script_assert 'Kill_Team_Flags zg³osi³o siê, zanim stworzono mapê strefy'
    endif
    FormatText checksumname = red_flag '%z_TRG_Flag_Red' z = <zone_name>
