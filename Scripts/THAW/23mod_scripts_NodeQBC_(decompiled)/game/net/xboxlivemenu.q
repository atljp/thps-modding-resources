...
script xbox_live_start_quickmatch 
    ...
    if GotParam ranked
        SetPreferencesFromUI {prefs = network field = 'ranked' string = 'Oceniony' checksum = ranked num = 0}
    else
        SetPreferencesFromUI {prefs = network field = 'ranked' string = 'Standardowy komunikat konsoli' checksum = standard num = 1}
    endif
...
script xbox_live_launch_session_find_dialog 
    xboxlive_dialog_box \{Title = "Xbox Live" text = "Szukanie sesji..." buttons = [{ text = 'Anuluj' pad_choose_script = xboxlive_menu_search_cancel }] no_bg}
endscript
    ...
    if NOT IsTrue xboxlive_shown_esrb_logo
        ...
        if ChecksumEquals a = <territory> b = territory_us
            ...
            xboxlive_dialog_box {
                ...
                sub_logo = ESRB
                text_dims = (500.0, 0.0)
                buttons = [{text = 'Pozwól mi graæ!' pad_choose_script = xboxlive_menu_create}]
                destroy_on_event = 1
            }
            return 
        endif
...
script xboxlive_menu_sign_off_confirm \{ back_script = xboxlive_menu_back_from_dialog }
    ...
    xboxlive_dialog_box {
        Title = 'Wypisz siê'
        text = 'Na pewno chcesz siê wypisaæ?'
        text_dims = (400.0, 0.0)
        pad_back_script = <back_script>
        no_bg
        buttons = [
            {text = 'Tak' pad_choose_script = xboxlive_menu_sign_off}
            {text = 'Nie' pad_choose_script = <back_script>}
        ]
    }
endscript
    ...
    if IsXbox
        menu_stack_push {
            ...
            menu_params = {
                ...
                Title = 'Lobby Xbox Live'
                title_pos = (50.0, 50.0)
                items = [
                    {text = 'Szybki mecz' pad_choose_script = xbox_live_start_quickmatch rot = 1 label_offset = (0.0, 0.0) Length = 220}
                    ...
                    {text = 'Stwórz mecz' pad_choose_script = xboxlive_menu_host_push rot = -1 label_offset = (10.0, 20.0) Length = 180 pad_choose_params = { set_default_focus }}
                    {text = 'Opcje Xbox Live' pad_choose_script = xboxlive_menu_options_push rot = -1 label_offset = (0.0, 40.0) Length = 230}
                    {text = 'Wypisz siê' pad_choose_script = xboxlive_menu_sign_off_confirm rot = 2 label_offset = (0.0, 30.0) Length = 200}
                ]
                xbox_live_menu_with_options_button
            }
        }
        ...
        menu_stack_push {
            ...
            menu_params = {
                ...
                title_pos = (50.0, 50.0)
                items = [
                    {text = 'Szybki mecz standardowy' pad_choose_script = xbox_live_start_quickmatch pad_choose_params = { standard }rot = 1 label_offset = (0.0, 0.0) Length = 220}
                    {text = 'Punktowana szybka gra' pad_choose_script = xbox_live_start_quickmatch pad_choose_params = { ranked }rot = 1 label_offset = (0.0, 0.0) Length = 220}
                    {text = <tmpText> pad_choose_script = xboxlive_menu_optimatch_push rot = 4 label_offset = (20.0, 5.0) Length = 200 pad_choose_params = { set_default_focus }}
                    {text = 'Stwórz mecz' pad_choose_script = xboxlive_menu_host_push rot = -1 label_offset = (10.0, 20.0) Length = 180 pad_choose_params = { set_default_focus }}
                ]
                xbox360_live_menu_with_options_button
...
script xbox_live_launch_invitamatch_dialog 
    ...
    menu_text = ('Czy chcia³by do³¹czyæ wiadomoæ g³osow¹ do tego zaproszenia?' + <inviter> + 'gry?')
    xboxlive_dialog_box {
        Title = 'Do³¹cz do gry'
        text = <menu_text>
        exclusive_device = <user_index>
        buttons = [
            {text = 'Tak' pad_choose_script = xboxlive_menu_find_invited_session}
            {text = 'Nie' pad_choose_script = xboxlive_menu_ignore_invited_session}
        ]
        no_bg
    }
endscript
...
script xboxlive_menu_optimatch_results_create 
    ...
    if NOT IsXenon
        tmp_title = 'Wyniki Optimatch'
    else
        tmp_title = 'Wyniki rozgrywki gracza'
    endif
    change xboxlive_num_results = 0
    ...
    xboxlive_dialog_box {
        ...
        buttons = [
            ...
            {text = 'Anuluj' pad_choose_script = xboxlive_menu_search_cancel}
        ]
        no_bg
    }
    ...
    if NOT IsXenon
        menu_stack_push {
            ...
            menu_params = {
                ...
                Title = 'Optimatch'
                items = [
                    {text = 'Tym gry' field = 'game_type_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (0.0, 0.0) Length = 150}
                    {text = 'Poziom' field = 'level_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (20.0, 5.0) Length = 150}
                    {text = 'Gracze' field = 'num_players_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (10.0, 20.0) Length = 150}
                    {text = 'Poziom umiejêt.' field = 'skill_level_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (0.0, 30.0) Length = 150}
                    {text = 'Znajd sesjê' id = optimatch_find_session pad_choose_script = xboxlive_menu_optimatch_results_push rot = 2 label_offset = (0.0, 30.0) Length = 150}
                ]
                xbox_live_menu_with_options_button
        ...
        menu_stack_push {
            ...
            menu_params = {
                ...
                pad_back_script = menu_stack_pop
                title_pos = (50.0, 50.0)
                Title = 'Pojedynczy mecz'
                items = [
                    {text = 'Standardowy, rangowy' field = 'ranked' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 label_offset = (0.0, 0.0) Length = 150}
                    {text = 'Tym gry' field = 'game_type_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (0.0, 0.0) Length = 150}
                    {text = 'Poziom' field = 'level_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (20.0, 5.0) Length = 150}
                    {text = 'Gracze' field = 'num_players_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (10.0, 20.0) Length = 150}
                    {text = 'Poziom umiejêt.' field = 'skill_level_optimatch' pad_choose_script = xboxlive_menu_pref_menu_create add_dont_care_option = 1 rot = 0 label_offset = (0.0, 30.0) Length = 150}
                    {text = 'Znajd sesjê' pad_choose_script = xboxlive_menu_optimatch_results_push rot = 2 label_offset = (0.0, 30.0) Length = 150}
                ]
                xbox360_live_menu_with_options_button
                additional_create_script = xboxlive_menu_prefs_field_create
            }
...
script xboxlive_menu_host_create 
    if NOT IsXenon
        menu_template_create {
            ...
            title_pos = (50.0, 50.0)
            items = [
                {text = 'Poziom' field = 'level' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Gracze' field = 'num_players' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Sloty prywatne' field = 'private_slots' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Poziom umiejêt.' field = 'skill_level' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Rozpocznij sesjê' id = start_session_button pad_choose_script = xboxlive_host_game rot = 2 Length = 150}
            ]
            xbox_live_menu_with_options_button
            additional_create_script = xboxlive_menu_prefs_field_create
        }
        ...
        menu_template_create {
            ...
            title_pos = (50.0, 50.0)
            items = [
                {text = 'Zwyk³y / Oceniony' field = 'ranked' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Poziom' field = 'level' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Gracze' field = 'num_players' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Sloty prywatne' field = 'private_slots' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Poziom umiejêt.' field = 'skill_level' pad_choose_script = xboxlive_menu_pref_menu_create rot = 0 Length = 150}
                {text = 'Rozpocznij sesjê' pad_choose_script = xboxlive_host_game rot = 2 Length = 150}
            ]
            xbox360_live_menu_with_options_button
            additional_create_script = xboxlive_menu_prefs_field_create
        }
...
script xboxlive_menu_scoreboard_push 
    if IsXbox
        menu_stack_push \{menu_script = menu_template_create menu_params = {menu_template_style_ticker parent = root_window menu_id = scoreboard_menu vmenu_id = scoreboard_vmenu pad_back_script = menu_stack_pop Title = 'Tablica wyników' title_pos = (50.0, 50.0) generic_helper_text}}
    else
...
script xboxlive_menu_voice_options_get_text 
    if NetSessionFunc \{ obj = voice func = hasvoicethroughspeakers }
        return \{ voice_option_text = 'G³oniki' }
    else
        return \{ voice_option_text = 'S³uchawki' }
    endif
endscript
...
script xboxlive_menu_appear_online_get_text 
    if NetSessionFunc \{ obj = presence func = is_appearing_online }
        return \{ online_text = 'Tak' }
    else
        return \{ online_text = 'Nie' }
    endif
endscript
...
script xboxlive_menu_options_create 
    ...
    if IsXbox
        menu_template_create {
            ...
            pad_back_script = <back_script>
            exclusive_device = <user_index>
            Title = 'Opcje Xbox Live'
            title_pos = (50.0, 50.0)
            items = [
                {text = 'Lista przyjació³' tag_grid_x = 0 pad_choose_script = xboxlive_menu_friends_push rot = -1 label_offset = (10.0, 20.0) Length = 180}
                {text = 'Lista graczy' tag_grid_x = 1 pad_choose_script = xboxlive_menu_players_push rot = 4 label_offset = (20.0, 5.0) Length = 200}
                {text = 'G³os przez:' tag_grid_x = 2 <voice_focus_params> extra_text = <voice_option_text> option_arrows option_arrows_callback = xboxlive_menu_voice_options_toggle rot = 1 label_offset = (10.0, 10.0)}
                {text = 'Obecnie online:' tag_grid_x = 3 extra_text = <online_text> option_arrows option_arrows_callback = xboxlive_menu_appear_online_toggle rot = -1 label_offset = (5.0, 15.0)}
            ]
            generic_helper_text
        }
        printstruct <...> 
...
script xboxlive_menu_voice_options_push 
    ...
    menu_stack_push {
        ...
        menu_params = {
            ...
            title_pos = (50.0, 50.0)
            items = [
                {text = 'Opcja 1' pad_choose_script = NullScript rot = -1 label_offset = (10.0, 20.0) Length = 180}
                {text = 'Opcja 2' pad_choose_script = NullScript rot = 4 label_offset = (20.0, 5.0) Length = 200}
            ]
            generic_helper_text
        }
    }
...
script xboxlive_menu_players_kick_confirm 
    xboxlive_dialog_box {Title = 'Wykop gracza'
        text = ('Czy na pewno chcesz wyrzuciæ' + <player_name> + '?')
        buttons = [
            {text = 'Tak' pad_choose_script = xboxlive_menu_players_kick pad_choose_params = <...> }
            {text = 'Nie' pad_choose_script = xboxlive_menu_players_item_choose_back}
        ]
    }
endscript
...
script xboxlive_menu_players_ban_confirm 
    xboxlive_dialog_box {Title = 'Zbanuj gracza'
        text = ('Czy na pewno chcesz zbanowaæ' + <player_name> + '?')
        buttons = [
            {text = 'Tak' pad_choose_script = xboxlive_menu_players_ban pad_choose_params = <...> }
            {text = 'Nie' pad_choose_script = xboxlive_menu_players_item_choose_back}
        ]
    }
endscript
...
script xboxlive_menu_players_item_choose 
    ...
    if IsXbox
        if NetSessionFunc obj = presence func = is_player_friend params = <player_structure>
            if NetSessionFunc obj = presence func = is_friend_pending params = <player_structure>
                buttons = {
                    text = 'Anuluj zaproszenie przyjaciela'
    ...
    push buttons
    xboxlive_dialog_box {
        Title = 'Czynnoæ gracza'
        text = ('Wybierz dzia³¹nie dla\n\'' + <player_name> + '\'')
        text_dims = (400.0, 0.0)
...
script xboxlive_menu_players_add_friend_prompt 
    ...
    NetSessionFunc obj = auth func = get_user_device_index
    if (<allow_message> = 1)
        xboxlive_dialog_box {Title = 'Przydziel g³os'
            text = 'Czy chcia³by do³¹czyæ wiadomoæ g³osow¹ do tego zaproszenia?'
            exclusive_device = <user_index>
            buttons = [
                {text = 'Tak' pad_choose_script = xboxlive_menu_record_voice_menu_create pad_choose_params = {accept_script = xboxlive_menu_players_add_friend accept_params = { <...> voice_msg }cancel_script = xboxlive_menu_players_item_choose_back}}
                {text = 'Nie' pad_choose_script = xboxlive_menu_players_add_friend pad_choose_params = <...> }
                {text = 'Anuluj' pad_choose_script = xboxlive_menu_players_item_choose_back}
            ]
        }
    else
...
script xboxlive_menu_players_feedback 
    ...
    xboxlive_dialog_box {
        Title = 'Opinie'
        text = ('Wybierz swoje wsparcie dla\n\'' + <player_name> + '\'')
        text_dims = (400.0, 0.0)
        ...
        buttons = [
            ...
            {
                text = 'Przeklinanie lub opryskliwosæ'
                pad_choose_script = xboxlive_menu_players_send_feedback_confirm
                pad_choose_params = {
...
script xboxlive_menu_players_send_feedback_confirm 
    NetSessionFunc \{ obj = auth func = get_user_device_index }
    xboxlive_dialog_box {Title = 'Wylij skargê'
        text = ('Czy na pewno chcesz wys³aæ to za¿alenie o' + <player_name> + '?')
        exclusive_device = <user_index>
        buttons = [
            {text = 'Tak' pad_choose_script = xboxlive_menu_players_send_feedback pad_choose_params = <...> }
            {text = 'Nie' pad_choose_script = xboxlive_menu_players_item_choose_back}
        ]
    }
endscript
...
script xboxlive_menu_pref_menu_create 
    ...
    switch <pref_field_checksum>
        ...
        action_script = xboxlive_menu_pref_item_add_generic
        default 
        scriptassert 'Niewype³nione pole ustawieñ'
    endswitch
    item_params = {
        menu_id = <menu_id>
        parent = pref_vmenu
...
script xboxlive_menu_optimatch_results_end 
    ...
    if (xboxlive_num_results = 0)
        if IsXbox
            xboxlive_dialog_box {
                Title = 'Xbox Live'
                text = 'Brak dostêpnych sesji. Czy chcia³by stworzyæ mecz?'
                pad_back_script = xboxlive_menu_search_cancel
                buttons = [
                    {text = 'Tak' pad_choose_script = xboxlive_menu_create_match_after_failed_search}
                    {text = 'Anuluj' pad_choose_script = xboxlive_menu_search_cancel}
                ]
                no_bg
            }
...
script xboxlive_menu_quickmatch_results_none 
    xboxlive_dialog_box_exit
    xboxlive_dialog_box \{Title = "Xbox Live" text = "Brak dostêpnych sesji. Czy chcia³by stworzyæ mecz?" pad_back_script = xboxlive_menu_search_cancel buttons = [{ text = 'Tak' pad_choose_script = xboxlive_menu_create_match_after_failed_search }{ text = 'Anuluj' pad_choose_script = xboxlive_menu_search_cancel }] no_bg}
endscript

script xboxlive_menu_invitamatch_results_none 
    xboxlive_dialog_box_exit
    xboxlive_dialog_box \{Title = "Xbox Live" text = "Nie znaleziono sesji. Czy chcesz stworzyæ grê?" pad_back_script = xboxlive_menu_search_cancel buttons = [{ text = 'Tak' pad_choose_script = xboxlive_menu_create_match_after_failed_search }{ text = 'Anuluj' pad_choose_script = xboxlive_menu_search_cancel }] no_bg}
endscript
...
script xboxlive_menu_record_voice_menu_process_state 
    ...
    switch <state>
        case stopped
        SetScreenElementProps id = { voice_attachment_popup child = text }text = 'Zatrzymano'
        ...
        case playing
        SetScreenElementProps id = { voice_attachment_popup child = text }text = 'Rozgrywana...'
        xboxlive_menu_record_voice_menu_set_button_state { button = record Off }
        xboxlive_menu_record_voice_menu_set_button_state { button = play Off }
        xboxlive_menu_record_voice_menu_set_button_state { button = send Off }
        case recording
        SetScreenElementProps id = { voice_attachment_popup child = text }text = 'Nagrywanie...'
        xboxlive_menu_record_voice_menu_set_button_state { button = record Off }
        xboxlive_menu_record_voice_menu_set_button_state { button = play Off }
        xboxlive_menu_record_voice_menu_set_button_state { button = send Off }
...
script gameinvite_already_in_game 
    create_panel_message {text = ('Ju¿ jeste w grze z ' + <inviter> + '.')
        time = 5000
    }
endscript

script gameinvite_server_unavailable 
    create_error_box {Title = 'Zaproszenie do gry'
        text = ('Nie uda³o siê skorzystaæ z zaproszenia. Ta gra ju¿ nie istnieje.')
...
script failedtocreategame 
    cancel_join_server
    create_error_box {Title = 'Do³¹cz do gry'
        text = ('Nie mo¿na do³¹czyæ do wybranej gry.')
        buttons = [{ text = 'OK' }
        ]
        no_animate
    }
...
script show_esrb 
    change \{ xboxlive_shown_esrb_logo = 1 }
    xboxlive_dialog_box \{Title = 'UWAGA' text = '' sub_logo = ESRB text_dims = (500.0, 0.0) buttons = [{ text = 'Pozwól mi graæ!' pad_choose_script = xboxlive_menu_create }] destroy_on_event = 1}
endscript
...
script AP_TEST 
    ...
    xboxlive_dialog_box {
        ...
        text = <menu_text>
        text_dims = (500.0, 0.0)
        buttons = [{text = 'Kontynuuj' pad_choose_script = <back_script>}]
        destroy_on_event = 1
    }
endscript
