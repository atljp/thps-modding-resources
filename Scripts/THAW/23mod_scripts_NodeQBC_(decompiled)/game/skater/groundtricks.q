...
#"0x1bff4f47" = {
    scr = Boneless
    params = { name = "Airshuffle" anim = AntiCasperFlip Score = 23 }
}
GroundTricks = [
    {
        trigger = {
...
script revert FSName = 'FS Revert' BSName = 'BS Revert' FSAnim = RevertFS BSAnim = RevertBS Score = 100
    ...
    if NOT GotParam no_special_friction
        #"0x00000000" [0 , 0 , 5 , 10 , 15 , 25] duration = 0.6670
    endif
    cankickoff
    ClearTrickQueue
...
script NollieBS360ShoveIt 
    ...
    SetTrickScore <Score>
    display
    Skater_Playanim \{ anim = NollieBS360ShoveIt BlendPeriod = 0.2000 }
    WaitAnimWhilstChecking
    goto \{ Airborne }
endscript
