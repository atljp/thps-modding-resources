custom_male_appearances = [
    { struct = appearance_custom_skater_male_01 name = 'Grzegorz' voice = male1 }
    { struct = appearance_custom_skater_male_02 name = 'Zbyszek' voice = male1 }
    { struct = appearance_custom_skater_male_03 name = 'Rocker' voice = male1 }
    { struct = appearance_custom_skater_male_04 name = 'Skejt 1' voice = male1 }
    { struct = appearance_custom_skater_male_05 name = 'Skejt 2' voice = male1 }
    { struct = appearance_custom_skater_male_06 name = 'Skejt 3' voice = male1 }
    { struct = appearance_custom_skater_male_07 name = 'Skejt 4' voice = male1 }
    { struct = appearance_custom_skater_female name = 'Trisha' Female = 1 voice = Female2 }
    { struct = Ped_Welder name = 'Welder' voice = male1 }
    { struct = Pro_Alva2 name = '70\'s Alva' voice = male1 }
    { struct = Ped_BillyJoe name = 'BillyJoe' voice = male1 }
    { struct = Ped_SignDude name = 'SignDude' voice = male1 }
    { struct = Ped_Vato name = 'Vato' voice = male1 }
    { struct = Ped_MexicanGraffiti name = 'Graffiti Guy' voice = male1 }
    { struct = Robot name = 'Robot' voice = male1 }
    { struct = Pro_THUGHawk name = 'THUG1 Tony Hawk' voice = male1 }
    { struct = Ped_AccGuy name = 'AccGuy' voice = male1 }
    { struct = Jimbo name = 'Jimbo' voice = male1 }
    { struct = Ped_ShopOwner name = 'Shop Owner' voice = male1 }
    { struct = Ped_Sunset_rocker2 name = 'Punk' voice = male1 }
    { struct = Ped_DVGuy name = 'DV Guy' voice = male1 }
    { struct = Ped_Baller name = 'Baller' voice = male1 }
    { struct = Ped_Construction name = 'Construction Guy' voice = male1 }
    { struct = Pro_HawkOldSchool name = 'Hawk OldSchool' voice = male1 }
    { struct = Ped_KidSkaterEastLA name = 'Skater Kid East LA' voice = male1 }
    { struct = Ped_SurPlus name = 'SurPlus Guy' voice = male1 }
    { struct = Ped_Barber name = 'Barber' voice = male1 }
    { struct = Ped_Clover name = 'Clover' Female = 1 voice = female1 }
    { struct = Ped_Murphy name = 'Murphy' voice = male1 }
    { struct = Pro_Ellis name = 'Ellis' voice = male1 }
    { struct = Ped_Carny name = 'Carny' voice = male1 }
    { struct = Pro_Hawk name = 'Tony Hawk' voice = male1 }
    { struct = Ped_KidSkater name = 'Kid Skater' voice = male1 }
    { struct = Arrow_test name = 'Arrow' voice = male1 }
    { struct = Ped_Mega name = 'Mega' voice = male1 }
    { struct = Ped_DogTownGuy name = 'DogTown Guy' voice = male1 }
    { struct = Ped_PerformerSilver name = 'Performer Silver' voice = male1 }
    { struct = Ped_Dave name = 'Dave' voice = male1 }
    { struct = Ped_OilRigWorker name = 'Oil Rig Worker' voice = male1 }
    { struct = Ped_HippieF_FullBody03 name = 'Protester 1' voice = male1 }
    { struct = Ped_Mindy name = 'Mindy' Female = 1 voice = female1 }
    { struct = Ped_photoguy name = 'Photo Guy' voice = male1 }
    { struct = Ped_ChineseMan name = 'Master Zen' voice = male1 }
    { struct = Ped_HippieF_FullBody01 name = 'Protester 2' voice = male1 }
    { struct = Ped_OldLady_Fullbody name = 'Old Lady' Female = 1 voice = female1 }
    { struct = Ped_FatConstruction name = 'Fat Construction Guy' voice = male1 }
    { struct = Ped_cholo name = 'Cholo' voice = male1 }
]
#"0x99a51a2a" = {
...
script get_skater_index_from_name 
    ...
    <index> = (<index> + 1)
    repeat <array_size>
    script_assert 'Nie znaleziono profilu o nazwie %n na licie najlepszych skejtów' n = <name>
endscript
master_skater_list = [
    {
        display_name = '\c423 \c0MoD by $kejt23'
        ...
        sticker_texture = 'CAGR/Corporate/corp_5'
