...
script set_correct_graffiti_textures 
    if NOT GotParam name
        script_assert 'nie ustalono imienia'
    endif
    GetCurrentSkaterProfileIndex
