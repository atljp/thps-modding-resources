...
script GetGameScriptFunctionList 
    ScriptFunctions = [
        {text = 'Prze³¹cz tryb wyboru mysz¹' , ScriptName = DebuggerCycleSelectMode}
        {text = 'Obejrzyj obrazek' , ScriptName = RequestImagePreview}
        {text = 'Wyczyæ przejrzane obrazy' , ScriptName = ClearSpritePreview}
        {text = 'Wylij kamerê do schowka' , ScriptName = CopyCameraLocationToClipboard}
    ]
    return <...> 
endscript
...
script RequestImagePreview_FileConverted 
    if GetRelativePath path = (<callbackparams>.filename)dir = 'images' discard_extension
        ...
        message = 'Sprite musi znajdowaæ siê w katalogu \'[proj_root]/data/images\', lub jego podkatalogu!'
        printf <message>
