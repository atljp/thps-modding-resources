mode_info = [
    ...
    { name = 'Scavenger Hunt' checksum = scavengerhunt definition = mode_scavengerhunt }
    { name = 'Score Challenge' checksum = scorechallenge definition = mode_scorechallenge }
    { name = 'Combo Mambo' checksum = combomambo definition = mode_combomambo }
    ...
    { name = 'Pot O\' Gold' checksum = gold definition = mode_gold }
    { name = 'Horse' checksum = horse definition = mode_horse }
    { name = 'Horse' checksum = nethorse definition = mode_nethorse }
    { name = 'Career' checksum = career definition = mode_career }
    { name = 'Net' checksum = net definition = mode_net }
    ...
    { name = 'Scavenger Hunt' checksum = netscavengerhunt definition = mode_netscavengerhunt }
    { name = 'Elimiskate' checksum = netelimiskate definition = mode_netelimiskate }
    { name = 'Score Challenge' checksum = netscorechallenge definition = mode_netscorechallenge }
    { name = 'Combo Mambo' checksum = netcombomambo definition = mode_netcombomambo }
    { name = 'Graffiti' checksum = netgraffiti definition = mode_netgraffiti }
    { name = 'Goal Attack' checksum = netgoalattack definition = mode_netgoalattack }
    { name = 'Slap!' checksum = netslap definition = mode_netslap }
    { name = 'King of the Hill' checksum = netking definition = mode_netking }
    { name = 'Pot O\' Gold' checksum = netgold definition = mode_netgold }
    ...
    { name = 'FireFight' checksum = firefight definition = mode_firefight }
    { name = 'FireFight' checksum = netfirefight definition = mode_netfirefight }
    { name = 'Classic Mode' checksum = classic definition = mode_classic }
    { name = 'Co-Op Mode' checksum = coop definition = mode_coop }
    { name = 'Create A Trick' checksum = CAT definition = mode_cat }
]
mode_freeskate = {
    name = freeskate
    initial_players = 1
...
script create_rankings score_title_text = 'SCORE'
    ...
    if IsXenon
        ...
        create_speech_box text = 'Press \m0 to continue' Pos = (320.0, 465.0) pad_choose_script = close_rankings
    endif
