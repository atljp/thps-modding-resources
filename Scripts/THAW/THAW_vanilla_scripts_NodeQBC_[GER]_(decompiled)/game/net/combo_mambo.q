...
script goal_combomambo_activate 
    if InTeamGame
        FormatText textname = msg_text '\c4Kombo-Mambo:\n\c0Höchste Punktkombo gewinnt.'
    else
        FormatText textname = msg_text '\c4Kombo-Mambo:\n\c0Höchste Punktkombo gewinnt.'
    endif
...
script goal_combomambo_expire 
    ...
    if GameModeEquals \{ is_singlesession }
        ...
        if OnServer
            SpawnScriptLater \{wait_then_create_rankings params = { score_title_text = 'BESTE KOMBO' }}
        else
            create_rankings \{ score_title_text = 'BESTE KOMBO' }
        endif
    endif
endscript
