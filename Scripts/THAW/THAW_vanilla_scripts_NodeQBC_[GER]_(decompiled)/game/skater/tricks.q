                ...
                if YawBetween (45.0, 60.0)
                    if airtimegreaterthan 0.7500 second
                        ...
                        if InSplitScreenGame
                            ...
                            LaunchPanelMessage '&C1Schlampig' properties = panelcombo
                        endif
                    else
                        PlayLandAnim <...> 
                    endif
...
script AwardPerfect 
    if NOT InSplitScreenGame
        create_panel_message text = 'Sauber!' id = perfect rgba = [ 50 150 50 128 ] Pos = (110.0, 340.0) style = perfect_style
        create_panel_message text = '+1000 Punkte' id = perfect2 rgba = [ 40 140 40 100 ] Pos = (110.0, 360.0) style = perfect_style
    else
        PerfectSloppy_2p text = 'Sauber!' rgb = [ 50 150 50 128 ]
    endif
...
script AwardSloppy 
    if currentscorepotgreaterthan 750
        ...
        if (<spin> > 359.0)
            if NOT InSplitScreenGame
                create_panel_message text = 'Schlampige Landung' id = perfect rgba = [ 200 50 50 128 ] Pos = (110.0, 340.0) style = sloppy_style
                create_panel_message text = '-500 Punkte' id = perfect2 rgba = [ 107 51 27 100 ] Pos = (110.0, 360.0) style = sloppy_style
            else
                PerfectSloppy_2p text = 'Schlampig!' rgb = [ 200 50 50 128 ]
            endif
            SetTrickName ''
            SetTrickScore -500
            display Blockspin NoDegrade
...
script GetBonus Score = 100 text = 'Bonus!' rgba = [ 50 150 50 128 ]
    if NOT InSplitScreenGame
        ...
        FormatText textname = text2 '%i Punkte' i = <Score>
                    ...
                    if NOT GotParam FromTaxiGuy
                        if NOT GameModeEquals is_goal_attack
                            ...
                            if GameModeEquals is_firefight
                                ...
                                wait 1 seconds
                                create_panel_message id = goal_message text = 'Warte auf andere Spieler. Drück \m0 zum Zuschauen.' style = panel_message_generic_loss time = 2000
                                if NOT IsObserving
                                    EnterSurveyorMode
                                endif
                            endif
    ...
    if InNetGame
        if GameIsOver
            ...
            if GameModeEquals is_king
                ...
                if NOT GotParam FromTaxiGuy
                    if NOT GameModeEquals is_goal_attack
                        create_panel_message id = goal_message text = 'Warte, bis die anderen Spieler fertig sind ...' style = panel_message_generic_loss
                    endif
                endif
            endif
        endif
    ...
    if GotParam turn_off
        ...
        if GotParam timelimit
            if NOT GetGlobalFlag flag = NO_DISPLAY_HUD
                create_panel_message text = 'Maximale Fokuszeit erreicht!' id = maxfocus style = focustimelimit_style
            endif
            printf 'time limit...........................'
        endif
    endif
