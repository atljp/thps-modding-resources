...
script test_scrolling_menu 
    make_new_themed_scrolling_menu Title = 'SCROLLEN'
    SetScreenElementProps {
        id = sub_menu
    ...
    theme_menu_add_item text = 'Anderen' pad_choose_script = null_script centered no_bg
    ...
    theme_menu_add_item text = 'Profi' pad_choose_script = null_script centered no_bg
    ...
    theme_menu_add_item text = 'Eins' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Zwei' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Drei' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Vier' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Fünf' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Sechs' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Sieben' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Acht' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Neun' pad_choose_script = null_script centered no_bg
    theme_menu_add_item text = 'Zehn' pad_choose_script = null_script centered no_bg last_item
    finish_themed_scrolling_menu
endscript

script make_new_themed_scrolling_menu Title = 'SCROLLEN' dims = (300.0, 227.0) Pos = (229.0, 80.0) right_bracket_z = 1
    if GotParam no_bar
