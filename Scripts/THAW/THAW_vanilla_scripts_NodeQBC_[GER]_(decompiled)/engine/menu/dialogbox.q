...
script create_snazzy_dialog_box {Title = 'Titel'
        text = 'Standardtext'
...
script create_test_dialog 
    ...
    create_dialog_box \{pad_back_script = create_test_menu buttons = [{ font = small text = 'Nein' pad_choose_script = create_test_menu }{ font = small text = 'Ja' pad_choose_script = null_script }]}
endscript
