...
script global_light_fx_menu_create {
                ...
                control_items = [
                    {
                        ...
                        control_items = [
                            {text = 'Red' param = ambient_red param_links = [ ambient_green ambient_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = ambient_green param_links = [ ambient_red ambient_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = ambient_blue param_links = [ ambient_red ambient_green ] min = 0 max = 255 step = 1}
                    ...
                    }
                    {
                        ...
                        control_items = [
                            ...
                            {text = 'Red' param = red_0 param_links = [ green_0 blue_0 ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = green_0 param_links = [ red_0 blue_0 ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = blue_0 param_links = [ red_0 green_0 ] min = 0 max = 255 step = 1}
                    ...
                    }
                    {
                        ...
                        control_items = [
                            ...
                            {text = 'Red' param = red_1 param_links = [ green_1 blue_1 ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = green_1 param_links = [ red_1 blue_1 ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = blue_1 param_links = [ red_1 green_1 ] min = 0 max = 255 step = 1}
                ...
                control_items = [
                    {
                        ...
                        structure = current_lighttool_params
                        control_items = [
                            {text = 'Red' param = lev_red param_links = [ lev_green lev_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = lev_green param_links = [ lev_red lev_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = lev_blue param_links = [ lev_red lev_green ] min = 0 max = 255 step = 1}
                        ]
                    }
                    {
                        text = 'Sky'
                        ...
                        structure = current_lighttool_params
                        control_items = [
                            {text = 'Red' param = sky_red param_links = [ sky_green sky_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = sky_green param_links = [ sky_red sky_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = sky_blue param_links = [ sky_red sky_green ] min = 0 max = 255 step = 1}
                        ]
                    }
                    {
                        text = 'Sun'
                        ...
                        control_items = [
                            ...
                            {text = 'Red' param = sun_red param_links = [ sun_green sun_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = sun_green param_links = [ sun_red sun_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = sun_blue param_links = [ sun_red sun_green ] min = 0 max = 255 step = 1}
                        ]
                    }
                    {
                        text = 'Fog'
                        ...
                        control_items = [
                            ...
                            {text = 'Red' param = fog_red param_links = [ fog_green fog_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = fog_green param_links = [ fog_red fog_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = fog_blue param_links = [ fog_red fog_green ] min = 0 max = 255 step = 1}
                    ...
                    }
                    {
                        ...
                        structure = current_lighttool_params
                        control_items = [
                            {text = 'Red' param = fog_sky_red param_links = [ fog_sky_green fog_sky_blue ] min = 0 max = 255 step = 1}
                            {text = 'Green' param = fog_sky_green param_links = [ fog_sky_red fog_sky_blue ] min = 0 max = 255 step = 1}
                            {text = 'Blue' param = fog_sky_blue param_links = [ fog_sky_red fog_sky_green ] min = 0 max = 255 step = 1}
                ...
                control_items = [
                    ...
                    }
                    {
                        ...
                        control_items = [
                            ...
                            {text = 'Scale' param = scales min = -5 max = 5 step = 0.05000 index_item_labels = [ 'Inner' 'Outer' ]}
        ...
        items_common_nocontrol = [
            ...
            {text = 'Hide tool, keep temp TOD (default)' pad_choose_script = global_light_fx_menu_hide}
            {text = 'Quit and restore original settings' pad_choose_script = global_light_fx_restore_original_tod_and_quit}
        ]
        buttons_common = [
            {
                binding = pad_circle
                callback = global_fx_toggle_preview
                text = '\m4: Toggle preview'
            }
            {
                binding = pad_r2
                callback = global_fx_toggle_focus
                text = '\ml: Toggle menu focus'
            }
        ]
    }
    ...
    global_fx_tool_message text = '\m1: Hide tool' parent = light_tool_helpers
...
script global_fx_menu_init_menu 
    ...
    global_fx_tool_message text = 'Light / FX tool is on' id = light_menu_on_message rgba = [ 80 80 128 128 ] parent = light_tool_anchor Pos = (320.0, 420.0)
endscript
...
script global_fx_toggle_preview 
    ...
    if (<save_toggle> = Original)
        global_fx_tool_message text = 'Looking at starting values.' id = light_menu_preview_message1 rgba = [ 128 80 80 128 ]
        global_fx_tool_message text = '   Changes won\'t be saved!' id = light_menu_preview_message2 rgba = [ 128 80 80 128 ]
...
script global_fx_toggle_focus light_menu = light_tool_vmenu
    if GotParam on
        ...
        global_fx_tool_message text = 'Tool is unfocused!' id = light_menu_focus_message rgba = [ 128 80 80 128 ]
        SetScreenElementProps {
            id = root_window
