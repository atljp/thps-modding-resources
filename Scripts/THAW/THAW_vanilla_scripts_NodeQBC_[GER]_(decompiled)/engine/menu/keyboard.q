...
script create_onscreen_keyboard {keyboard_title = 'TASTATUR'
    ...
    if NOT GotParam no_buttons
        if GotParam allow_cancel
            create_helper_text {helper_text_elements = [{ text = '\b7/\b4/\b6/\b5=Wahl' }
                    { text = '\m1=Zurück' }
                    { text = '\m0=OK' }
                    { text = '\mf/\mg=Zeichensatz' }
                ]
