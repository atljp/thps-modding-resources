...
accelCarRot = 0.00000000000 
decelCarRot = 0.00000000000 
speedCarRot = 0.00000000000 
accelCarRotFactor = 0.00000000000 
...
SCRIPT car_set_exceptions trigger_radius = 16 
	...
	SetException ex = ObjectInRadius scr = car_inner_radius_handler 
	Block 
ENDSCRIPT
		...
		IF ( <skater_ready_for_goal> = 1 ) 
			IF NOT <skaterId> : IsInBail 
				IF NOT SkaterCurrentScorePotGreaterThan 0 
					...
					<objId> : SetException ex = ObjectOutOfRadius scr = car_refuse 
