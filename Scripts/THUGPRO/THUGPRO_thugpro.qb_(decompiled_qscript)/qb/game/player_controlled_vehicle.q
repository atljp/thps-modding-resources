...
SCRIPT lock_car_to_non_local_skater 
	...
	<NonLocalPlayerVehicle> : Obj_LockToObject Id = <SkaterId> ( VECTOR(0.00000000000, 0.00000000000, 0.00000000000) - ( <VehicleSetup> . skater_pos ) ) 
...
VehicleSetupMapping = { 
	JunkerCar = TransCarSetup 
	RallyCar = CustomCarSetup 
	ImpalaCar = ImpalaCarSetup 
	TaxiNY = TaxiNYSetup 
	PoliceCar = PoliceCarSetup 
	SecurityCart = SecurityCartSetup 
	GardnersCart = GardnersCartSetup 
	ElCaminoCar = ElCaminoCarSetup 
	Blimp = BlimpSetup 
	LadaCar = LadaCarSetup 
	MiniBajaCar = MiniBajaCarSetup 
	LimoCar = LimoCarSetup 
	Forklift = ForkliftSetup 
	RCCar = RCCarSetup 
	TaurusCar = TaurusCarSetup 
	PickupTruck = PickupTruckSetup 
	WranglerCar = WranglerCarSetup 
	SportsCar = SportsCarSetup 
	OffroadCar = OffroadCarSetup 
} 
SCRIPT GetVehicleSetup 
	IF StructureContains Structure = ( VehicleSetupMapping ) <control_type> 
		RETURN VehicleSetup = ( VehicleSetupMapping . <control_type> ) 
	ELSE 
...
TaxiNYSetup = { 
	control_type = TaxiNY 
	model = "Veh\\NY\\Veh_Cab_NY\\Veh_Cab_NY.mdl" 
	level = Load_FL 
	alternate_level = 0 
	sounds = NY_JunkCar 
	skater_pos = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) 
...
TaurusCarSetup = { 
	control_type = TaurusCar 
	model = "veh\\veh_taurustype\\veh_TaurusType.mdl" 
	level = Load_RU 
	alternate_level = 0 
	sounds = NY_JunkCar 
	skater_pos = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) 
...
RCCarSetup = { 
	...
	suspension_center_of_mass = VECTOR(0.00000000000, -10.00000000000, 0.00000000000) 
	mass = 2943 
	moment_of_inertia = VECTOR(6000000.00000000000, 6000000.00000000000, 6000000.00000000000) 
	body_restitution = 0.30000001192 
	body_friction = 0.20000000298 
	...
	colliders = [ 
		[ 
			VECTOR(42.00000000000, 12.00000000000, 92.00000000000) 
			VECTOR(-42.00000000000, 12.00000000000, 92.00000000000) 
			VECTOR(42.00000000000, 12.00000000000, -80.00000000000) 
		] 
		[ 
			VECTOR(22.00000000000, 42.00000000000, 18.00000000000) 
			VECTOR(-22.00000000000, 42.00000000000, 18.00000000000) 
			VECTOR(22.00000000000, 52.00000000000, -74.00000000000) 
		] 
	] 
	engine = { 
		drive_torque = 400 
...
PickupTruckSetup = { 
	control_type = PickupTruck 
	model = "veh\\veh_pickup\\veh_pickup.mdl" 
	suspension_center_of_mass = VECTOR(0.00000000000, -10.00000000000, 0.00000000000) 
	mass = 2943 
	moment_of_inertia = VECTOR(6000000.00000000000, 5000000.00000000000, 6000000.00000000000) 
	body_restitution = 0.30000001192 
	...
	colliders = [ 
		...
		[ 
			VECTOR(22.00000000000, 38.00000000000, 4.00000000000) 
			VECTOR(-22.00000000000, 38.00000000000, 4.00000000000) 
			VECTOR(22.00000000000, 46.00000000000, -76.00000000000) 
		] 
	] 
	engine = { 
		drive_torque = 550 
...
SportsCarSetup = { 
	control_type = SportsCar 
	model = "veh\\veh_smallsportscar\\veh_smallsportscar.mdl" 
	sounds = NY_JunkCar 
	suspension_center_of_mass = VECTOR(0.00000000000, -16.00000000000, 0.00000000000) 
	mass = 2400 
	moment_of_inertia = VECTOR(6000000.00000000000, 5500000.00000000000, 6000000.00000000000) 
	body_restitution = 0.00000000000 
	body_friction = 0.10000000149 
	body_wipeout_friction = 0.40000000596 
	body_spring = 1200 
	collision_control = 0.20000000298 
	...
	colliders = [ 
		[ 
			VECTOR(39.50000000000, 0.00000000000, 108.00000000000) 
			VECTOR(-39.50000000000, 0.00000000000, 108.00000000000) 
			VECTOR(39.50000000000, 0.00000000000, -82.00000000000) 
		] 
		[ 
			VECTOR(35.00000000000, 22.00000000000, 26.00000000000) 
			VECTOR(-35.00000000000, 22.00000000000, 26.00000000000) 
			VECTOR(35.00000000000, 22.00000000000, -34.00000000000) 
		] 
	] 
	engine = { 
		drive_torque = 300 
		...
		upshift_rpm = 7500 
		differential_ratio = 5 
		reverse_torque_ratio = 0.75000000000 
		gear_ratios = [ 
			5 
			3.50000000000 
			1.50000000000 
	...
	wheels = [ 
		{ 
			...
			drive = no 
			brake_torque = 1050 
			dynamic_friction = 2.50000000000 
			handbrake_throttle_friction = 2.50000000000 
			handbrake_locked_friction = 4.50000000000 
		} 
		{ 
			max_draw_y_offset = -25 
			steering = right 
		...
		{ 
			...
			drive = yes 
			brake_torque = 1300 
			dynamic_friction = 1.60000002384 
			handbrake_throttle_friction = 1.60000002384 
			handbrake_locked_friction = 1.60000002384 
		} 
		{ 
			max_draw_y_offset = -21 
			steering = fixed 
...
TestCarSetup = { 
	control_type = TestCar 
	model = "Veh\\Veh_BH_cop\\Veh_BH_cop.mdl" 
	level = Load_FL 
	alternate_level = 0 
	sounds = NY_JunkCar 
	skater_pos = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) 
