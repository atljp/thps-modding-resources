...
SCRIPT got_gap_for_first_time 
	...
	<level> = ( <level_structure_name> . load_script ) 
	IF NOT ArrayContains array = [ load_BO load_ST load_AU Load_Sk5Ed_gameplay Load_Sk5Ed Load_SE Load_sc Load_Se2 Load_tr Load_ba Load_be Load_ap Load_ca Load_la ] contains = <level> 
		RETURN 
	ENDIF 
	printf <gap_text> 
