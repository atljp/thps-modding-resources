...
max_wheel_speed = 16.00000000000 
ResetCameraToViewerObject = 1 
UsePlayerPosForViewerObjPos = 1 
ApplyViewerObjModelToPlayer = 1 
DefaultViewerObjPos = VECTOR(0.00000000000, 50000.00000000000, 0.00000000000) 
...
SCRIPT create_human_model_set 
	...
	make_select_view_model_line text = "Price" profile = Price_SecretGuy animLoadScript = animload_thps6_human skeletonName = thps6_human defaultAnim = Ped_M_Idle1 skeletonName = thps6_human 
...
SCRIPT draw_viewer_object_panel 
	...
	ELSE 
		create_panel_message id = vo_line2 text = <line2> style = panel_message_viewobj_line params = { xy = PAIR(40.00000000000, 400.00000000000) } 
		create_panel_message id = vo_line3 text = <line3> style = panel_message_viewobj_line params = { xy = PAIR(40.00000000000, 420.00000000000) } 
		create_panel_message id = vo_line4 text = <line4> style = panel_message_viewobj_line params = { xy = PAIR(40.00000000000, 440.00000000000) } 
	ENDIF 
ENDSCRIPT
...
SCRIPT panel_message_viewobj_line 
	...
	DoMorph pos = <xy> alpha = 1 scale = 0.25000000000 
ENDSCRIPT
...
SCRIPT make_select_view_model_line { 
	...
	CreateScreenElement { 
		...
		font = bebas 
		scale = 0.20000000298 
		dims = PAIR(320.00000000000, 20.00000000000) 
		rgba = <rgba> 
		event_handlers = [ 
...
SCRIPT create_view_models_menu 
	...
	make_new_menu menu_id = view_models_menu vmenu_id = view_models_vmenu menu_title = "MODELS" type = vscrollingmenu dims = PAIR(320.00000000000, 200.00000000000) pos = PAIR(30.00000000000, 20.00000000000) 
...
SCRIPT SkaterScriptForReloadAndTestAnim Speed = 1.00000000000 
...
SCRIPT SkaterScriptTestAnimSequence Speed = 1.00000000000 
	SetSpeed 0 
	SetRollingFriction 100 
