...
SCRIPT create_existing_goals_menu 
	...
	IF ( <num_lines> > 8 ) 
		num_lines = 8 
	ENDIF 
	make_new_themed_scrolling_menu title = "CREATED GOALS" dims = ( PAIR(300.00000000000, 0.00000000000) + PAIR(0.00000000000, 1.00000000000) * 23 * <num_lines> ) 
...
SCRIPT create_goal_type_select_menu 
	...
	theme_menu_add_item { 
		...
		last_item 
		centered = 1 
		last_menu_item = 1 no_highlight_bar 
	} 
...
SCRIPT create_edit_goal_menu 
	...
	SWITCH <goal_type> 
		...
		CASE HighCombo 
			theme_menu_add_number_item { 
				...
				pad_choose_script = launch_cag_score_kb 
				first_item 
		...
		CASE Skatetris 
			theme_menu_add_item { 
				...
				first_item 
				text_pos = PAIR(75.00000000000, -5.00000000000) no_highlight_bar 
			} 
		CASE ComboSkatetris 
			theme_menu_add_item { 
	...
	theme_menu_add_item { 
		...
		text_pos = PAIR(75.00000000000, -5.00000000000) 
		pad_choose_script = name_goal no_highlight_bar 
	} 
	theme_menu_add_item { 
		text = "Name Ped" 
		extra_text = <ped_name> 
		text_pos = PAIR(75.00000000000, -5.00000000000) 
		pad_choose_script = name_goal_ped no_highlight_bar 
	} 
	theme_menu_add_item { 
		text = "Set Goal Text" 
		text_pos = PAIR(75.00000000000, -5.00000000000) 
		pad_choose_script = set_goal_text no_highlight_bar 
	} 
	theme_menu_add_item { 
		text = "Edit Win Message" 
		text_pos = PAIR(75.00000000000, -5.00000000000) 
		pad_choose_script = edit_goal_win_message no_highlight_bar 
	} 
	SWITCH <goal_type> 
		CASE TrickBeat 
		CASE Skatetris 
	...
	IF NOT CustomParkMode editing 
		...
		theme_menu_add_item { 
			...
			not_focusable = <not_focusable> no_highlight_bar 
		} 
	ENDIF 
	theme_menu_add_item { 
		text = "Done" 
...
SCRIPT launch_cag_score_kb 
	...
	create_onscreen_keyboard { allow_cancel 
		...
		keyboard_done_script = set_cag_goal_score 
		keyboard_title = "GOAL SCORE" 
		text = <value> 
		allowed_characters = [ "1" "2" "3" "4" "5" "6" "7" "8" "9" "0" ] 
	} 
ENDSCRIPT

SCRIPT set_cag_goal_score 
	GetTextElementString id = keyboard_current_string 
	StringToInteger String 
	GoalEditor : SetGoalScore <String> 
	cag_cancel_keyboard 
ENDSCRIPT
...
SCRIPT create_gap_select_menu 
	...
	IF ObjectExists id = current_menu_anchor 
		DestroyScreenElement id = current_menu_anchor 
	ENDIF 
	make_new_themed_scrolling_menu title = "SELECT GAPS" dims = ( PAIR(300.00000000000, 0.00000000000) + PAIR(0.00000000000, 1.00000000000) * 23 * <num_menu_lines> ) 
	SetScreenElementProps { 
		id = sub_menu 
