...
THUGPRO_classic_mode_skip_cameras = 0 
SCRIPT classic_mode_menu_add_pause_options 
	make_thpg_menu_item text = "retry level" id = menu_classic_retry pad_choose_script = classic_mode_retry 
	IF root_window : GetSingleTag no_exit_pause_menu 
		make_thpg_menu_item text = "view goal cameras" id = menu_classic_goals pad_choose_script = classic_mode_view_goal_cameras 
	ENDIF 
	make_thpg_menu_item text = "view goals" id = menu_classic_goals_list pad_choose_script = classic_mode_view_goals 
ENDSCRIPT

SCRIPT classic_mode_menu_add_quit_option 
	IF NOT root_window : GetSingleTag no_exit_pause_menu 
		make_thpg_menu_item text = "end run" id = menu_classic_endrun pad_choose_script = classic_mode_choose_end_run 
	ELSE 
		make_thpg_menu_item text = "quit" id = menu_skateshop pad_choose_script = generic_menu_pad_choose pad_choose_params = { callback = menu_confirm_quit } 
	ENDIF 
ENDSCRIPT
...
SCRIPT classic_mode_end_run 
	...
	spawnscript PlayClassicIntroCameras params = 
	{ 
		callback = classic_mode_view_goals 
		GoalList = <GoalList> 
		end_run 
	} 
ENDSCRIPT
...
SCRIPT classic_mode_process_intro_cameras show_beaten = 0 
	IF NOT IsTrue THUGPRO_classic_mode_skip_cameras 
		GoalManager_GetGoalList 
		...
		BEGIN 
			...
			IF GotParam view_goals_cameras 
