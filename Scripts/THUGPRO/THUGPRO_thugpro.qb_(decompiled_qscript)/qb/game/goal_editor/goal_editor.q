...
SCRIPT ChooseRandomCreatedGoalPedModel 
	IF ( ( LevelIs Load_Sk5Ed ) | ( LevelIs Load_Sk5Ed_gameplay ) ) 
		GetEditorTheme 
		IF ( <theme> = 16 ) 
			Obj_InitModel model = "Peds/Ped_imp/Ped_imp.skin" use_asset_manager = 1 
		ELSE 
...
SCRIPT cursor_ped_script 
	BEGIN 
		IF ( ( LevelIs Load_Sk5Ed ) | ( LevelIs Load_Sk5Ed_gameplay ) ) 
			RANDOM(1, 10) RANDOMCASE Obj_PlayAnim Anim = WStand 
				RANDOMCASE Obj_PlayAnim Anim = WStand 
			RANDOMEND 
		ELSE 
			RANDOM(1, 1, 1) RANDOMCASE Obj_PlayAnim Anim = Ped_M_Cheering RANDOMCASE Obj_PlayAnim Anim = Ped_M_ThumbUp RANDOMCASE Obj_PlayAnim Anim = Ped_M_Clap RANDOMEND 
		ENDIF 
...
SCRIPT goal_editor_get_beat_pattern 
	beat_pattern = [ 
		{ sounds = [ { BailBodyPunch02_11 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 100 + PAIR(0.10000000149, 3.00000000000) ) } ] 
		} 
		{ } 
		{ sounds = [ { BailBoard02 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 200 + PAIR(0.10000000149, 3.00000000000) ) } 
				{ DE_PauseFlyIn vol = ( 75 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 150 + PAIR(0.10000000149, 3.00000000000) ) } 
			] 
		} 
		{ } 
		{ pulse 
			sounds = [ { BailBodyFall01 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 200 + PAIR(0.10000000149, 3.00000000000) ) } 
				{ BailBodyFall04 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 140 + PAIR(0.10000000149, 3.00000000000) ) } 
			] 
		} 
		{ } 
		{ sounds = [ { BailBoard02 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 200 + PAIR(0.10000000149, 3.00000000000) ) } ] 
		...
		{ } 
		{ sounds = [ { BailBoard02 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 200 + PAIR(0.10000000149, 3.00000000000) ) } 
				{ BailBodyPunch02_11 vol = ( 100 + PAIR(0.10000000149, 4.00000000000) ) pitch = ( 100 + PAIR(0.10000000149, 3.00000000000) ) } 
			] 
		} 
		{ } 
	] 
