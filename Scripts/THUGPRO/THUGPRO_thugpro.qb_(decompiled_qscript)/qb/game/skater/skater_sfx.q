...
AmbientTrackNum = 0 
ForceAmbientSFXToMusicVolume = 1 
...
SCRIPT LoadPermSounds 
	LoadPermSFX 
	THUGPRO_RefreshSoundtracks 
	THUGPRO_LoadLastUsedSoundtrack 
ENDSCRIPT
...
SCRIPT LoadPermSFX 
	...
	LoadSound "Shared\\Menu\\PA_MenuSelect" FLAG_PERM vol = 80 
	LoadSound "Shared\\Menu\\PA_MenuBack" FLAG_PERM vol = 80 
	LoadSound "Shared\\Menu\\MENU_left_rightB" FLAG_PERM vol = 100 NOREVERB 
	LoadSound "Shared\\Menu\\MenuDown" FLAG_PERM vol = 100 NOREVERB 
	LoadSound "Shared\\Menu\\menu06" FLAG_PERM vol = 100 NOREVERB 
	LoadSound "Shared\\Menu\\menu06a" FLAG_PERM vol = 100 NOREVERB 
	LoadSound "Shared\\Menu\\menu03" FLAG_PERM vol = 100 NOREVERB 
	...
	LoadSound "Shared\\Goals\\Cash" FLAG_PERM NOREVERB 
	...
	LoadSound "Shared\\Goals\\ExtraTrick" FLAG_PERM NOREVERB vol = 50 
	...
	LoadSound "Shared\\Goals\\GoalGood" FLAG_PERM NOREVERB 
	LoadSound "Shared\\Goals\\pedprops" FLAG_PERM vol = 100 
	LoadSound "NY\\NY_PoliceChirp01" FLAG_PERM vol = 100 
	LoadSound "BO\\SK6_BO_FireLoop" FLAG_PERM vol = 100 
	LoadSound "Skater\\laserfire" FLAG_PERM vol = 80 
	LoadSound "SE\\SK6_SE_DoorsOpen" FLAG_PERM vol = 80 
	LoadSound "THUGPRO\\Menu\\ExtraTrick_THPS4" FLAG_PERM NOREVERB vol = 100 
	LoadSound "Shared\\Misc\\ElevatorDing" FLAG_PERM NOREVERB vol = 100 
	LoadSound "Skater\\whoosh" FLAG_PERM vol = 80 
ENDSCRIPT
...
playlist_tracks = [ 
	{ band = "25 Ta Life" track_title = "Over the Years" genre = 2 path = "25TaLife" } 
	{ band = "Aesop Rock" track_title = "No Jumper Cables(re-mix)" genre = 1 path = "Aesop" } 
	{ band = "Atmosphere" track_title = "Trying to Find a Balance" genre = 1 path = "Atmosphere" } 
	{ band = "Audio Two" track_title = "Top Billin\'" genre = 1 path = "AudioTwo" } 
	{ band = "Brand Nubian" track_title = "Punks Jump Up To Get Beat Down" genre = 1 path = "Nubian" } 
	{ band = "Camaros" track_title = "Cheesecake" genre = 0 path = "Camaros" } 
	{ band = "Cut Chemist" track_title = "Drums of Fire" genre = 1 path = "CutChemist" } 
	{ band = "Das Oath" track_title = "Awesome R***" genre = 2 path = "Oath" } 
	{ band = "Dead Boys" track_title = "Sonic Reducer" genre = 0 path = "DeadBoys" } 
	{ band = "Dead End Road" track_title = "Sin City" genre = 2 path = "DeadEndRoad" } 
	{ band = "Disturbed" track_title = "Liberate" genre = 2 path = "Disturbed" } 
	{ band = "Diverse" track_title = "Certified" genre = 1 path = "Diverse" } 
	{ band = "Faith No More" track_title = "Midlife Crisis" genre = 2 path = "FaithNoMore" } 
	{ band = "Fear" track_title = "I Love Livin\' In The City" genre = 0 path = "Fear" } 
	{ band = "Frank Sinatra" track_title = "That\'s Life" genre = 2 path = "Frank" } 
	{ band = "Grand Puba" track_title = "I Like It" genre = 1 path = "GrandPuba" } 
	{ band = "Handsome Boy...School" track_title = "Holy Calamity" genre = 1 path = "HandsomeBoy" } 
	{ band = "Iggy & The Stooges" track_title = "1970" genre = 0 path = "TheStooges" } 
	{ band = "Jimmy Eat World" track_title = "Pain" genre = 0 path = "Jimmy" } 
	{ band = "Johnny Cash" track_title = "Ring of Fire" genre = 2 path = "JohnnyCash" } 
	{ band = "Joy Division" track_title = "Warsaw" genre = 0 path = "JoyD" } 
	{ band = "Lamb of God" track_title = "Black Label" genre = 2 path = "LambofGod" } 
	{ band = "Less Than Jake" track_title = "That\'s Why They...Union" genre = 0 path = "Jake" } 
	{ band = "Libretto" track_title = "Volume" genre = 1 path = "Libretto" } 
	{ band = "Living Legends" track_title = "Night Prowler" genre = 1 path = "LivingL" } 
	{ band = "Melbeatz f.Kool Savas" track_title = "Grind on" genre = 1 path = "Melbeatz" } 
	{ band = "Melvins" track_title = "Sweet Willie Rollbar" genre = 0 path = "Melvins" } 
	{ band = "Metallica" track_title = "Whiplash" genre = 2 path = "Metallica" } 
	{ band = "Mike V and The Rats" track_title = "Never Give Up" genre = 0 path = "MikeV" } 
	{ band = "Ministry" track_title = "No    " genre = 2 path = "Ministry" } 
	{ band = "Nebula" track_title = "So it Goes" genre = 2 path = "Nebula" } 
	{ band = "Operatic" track_title = "Interested In Madness" genre = 2 path = "Operatic" } 
	{ band = "Pete Rock&CL Smooth" track_title = "Soul Brother #1" genre = 1 path = "PeteRock" } 
	{ band = "Rancid" track_title = "Fall Back Down" genre = 0 path = "Rancid" } 
	{ band = "Red Hot Chili Peppers" track_title = "The Power of Equality" genre = 0 path = "RedHots" } 
	{ band = "Steel Pulse" track_title = "Born Fe Rebel" genre = 2 path = "SteelPulse" } 
	{ band = "Suicide Machines" track_title = "High Anxiety" genre = 0 path = "SuicideMachines" } 
	{ band = "The Casualties" track_title = "Unknown Soldier" genre = 0 path = "TheCasualties" } 
	{ band = "The D.O.C." track_title = "Whirlwind Pyramid" genre = 1 path = "DOC" } 
	{ band = "The Distillers" track_title = "Beat Your Heart Out" genre = 0 path = "Distillers" } 
	{ band = "The Doors" track_title = "Break On Through" genre = 2 path = "TheDoors" } 
	{ band = "The Explosion" track_title = "Here I Am" genre = 0 path = "TheExplosion" } 
	{ band = "The Germs" track_title = "Lexicon Devil" genre = 0 path = "TheGerms" } 
	{ band = "The Hiss" track_title = "Back on the Radio" genre = 2 path = "Hiss" } 
	{ band = "The Living End" track_title = "End of the World" genre = 2 path = "LivingEnd" } 
	{ band = "The Ramones" track_title = "Rock \'n Roll High School" genre = 0 path = "TheRamones" } 
	{ band = "The Sugarhill Gang" track_title = "Rapper\'s Delight" genre = 1 path = "TheSugarhill" } 
	{ band = "Three Inches of Blood" track_title = "Deadly Sinners" genre = 2 path = "ThreeInches" } 
	{ band = "Ultramagnetic MC\'s" track_title = "Ego Trippin\'" genre = 1 path = "Ultramagnetic" } 
	{ band = "Violent Femmes" track_title = "Add It Up" genre = 2 path = "VFemmes" } 
	{ band = "Ween" track_title = "It\'s Gonna Be a Long Night" genre = 2 path = "Ween" } 
	{ band = "X" track_title = "Los Angeles" genre = 2 path = "XLA" } 
	{ band = "ZEKE" track_title = "Long Train Runnin\'" genre = 2 path = "ZEKE" } 
] 
...
SCRIPT Ped_Skater_Grind_Bail_Sound 
	...
	RANDOM_NO_REPEAT(1, 1, 1, 1, 1) 
		RANDOMCASE Obj_PlaySound BailBoard01 pitch = PAIR(100.00000000000, 102.00000000000) vol = PAIR(40.00000000000, 50.00000000000) 
		RANDOMCASE Obj_PlaySound BailBoard02 pitch = PAIR(100.00000000000, 102.00000000000) vol = PAIR(40.00000000000, 50.00000000000) 
		RANDOMCASE Obj_PlaySound BailBoard03 pitch = PAIR(100.00000000000, 102.00000000000) vol = PAIR(40.00000000000, 50.00000000000) 
		RANDOMCASE Obj_PlaySound BailBoard04 pitch = PAIR(100.00000000000, 102.00000000000) vol = PAIR(40.00000000000, 50.00000000000) 
		RANDOMCASE Obj_PlaySound BailBoard05 pitch = PAIR(100.00000000000, 102.00000000000) vol = PAIR(40.00000000000, 50.00000000000) 
	RANDOMEND 
	RANDOM_NO_REPEAT(1, 1, 1, 1, 1) 
		RANDOMCASE Obj_PlaySound BailBodyFall01 pitch = PAIR(95.00000000000, 105.00000000000) vol = PAIR(60.00000000000, 80.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyFall02 pitch = PAIR(95.00000000000, 105.00000000000) vol = PAIR(60.00000000000, 80.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyFall03 pitch = PAIR(95.00000000000, 105.00000000000) vol = PAIR(60.00000000000, 80.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyFall04 pitch = PAIR(95.00000000000, 105.00000000000) vol = PAIR(60.00000000000, 80.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyFall05 pitch = PAIR(95.00000000000, 105.00000000000) vol = PAIR(60.00000000000, 80.00000000000) 
	RANDOMEND 
ENDSCRIPT
...
SCRIPT Temp_Ped_Fall_Sound 
	RANDOM_NO_REPEAT(1, 1, 1, 1, 1) 
		RANDOMCASE Obj_PlaySound BailBodyPunch01_11 pitch = PAIR(80.00000000000, 102.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyPunch02_11 pitch = PAIR(80.00000000000, 102.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyPunch03_11 pitch = PAIR(80.00000000000, 102.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyPunch04_11 pitch = PAIR(80.00000000000, 102.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailBodyPunch05_11 pitch = PAIR(80.00000000000, 102.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
	RANDOMEND 
	RANDOM_NO_REPEAT(1, 1, 1) 
		RANDOMCASE Obj_PlaySound BailSlap01 pitch = PAIR(95.00000000000, 115.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailSlap02 pitch = PAIR(95.00000000000, 115.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
		RANDOMCASE Obj_PlaySound BailSlap03 pitch = PAIR(95.00000000000, 115.00000000000) vol = PAIR(100.00000000000, 120.00000000000) 
	RANDOMEND 
ENDSCRIPT
...
SCRIPT Menu_SFX_Wheel_Click_Short 
	PlaySound MenuUp pitch = PAIR(98.00000000000, 102.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.10000000149 seconds 
	PlaySound MenuUp pitch = PAIR(98.00000000000, 102.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
ENDSCRIPT

SCRIPT Menu_SFX_Wheel_Click_Long 
	PlaySound MenuUp pitch = PAIR(105.00000000000, 110.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(100.00000000000, 107.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(98.00000000000, 105.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(98.00000000000, 102.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(90.00000000000, 95.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(90.00000000000, 95.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(90.00000000000, 95.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
	PlaySound MenuUp pitch = PAIR(87.00000000000, 89.00000000000) vol = PAIR(50.00000000000, 60.00000000000) 
	wait 0.05000000075 seconds 
ENDSCRIPT
...
SCRIPT Auto_SFX_Car_Tire_Squeal 
	IF NOT ( IsStreamPlaying LA_Skid ) 
		Obj_PlayStream LA_Skid vol = PAIR(30.00000000000, 60.00000000000) 
	ENDIF 
ENDSCRIPT

SCRIPT Auto_SFX_CarBrakeSqueal 
	IF NOT ( IsStreamPlaying CarBrakeSqueal ) 
		Obj_PlayStream CarBrakeSqueal vol = PAIR(5.00000000000, 20.00000000000) pitch = PAIR(80.00000000000, 100.00000000000) priority = StreamPriorityLow 
	ENDIF 
ENDSCRIPT
...
SCRIPT Auto_SFX_Car_Horn_Stream 
	IF NOT ( IsStreamPlaying CarHorn ) 
		...
		Obj_PlayStream CarHorn vol = PAIR(50.00000000000, 60.00000000000) pitch = PAIR(80.00000000000, 100.00000000000) dropoff = 120 
	ENDIF 
ENDSCRIPT

SCRIPT Auto_SFX_Car_Siren_Stream 
	IF NOT ( IsStreamPlaying CarHorn ) 
		wait RANDOM_RANGE PAIR(0.20000000298, 0.60000002384) 
		Obj_PlaySound NY_PoliceChirp01 vol = PAIR(5.00000000000, 20.00000000000) pitch = PAIR(80.00000000000, 100.00000000000) 
	ENDIF 
ENDSCRIPT
...
SCRIPT SFX_Change_Footstep_Sounds_To_Default 
	IF ( ( isTrue THUGPRO_Footstep_Sounds_Changed ) | ( LevelIs load_au ) ) 
		IF NOT LevelIs load_au 
			change THUGPRO_Footstep_Sounds_Changed = 0 
		ENDIF 
...
SCRIPT SFX_Change_Footstep_Sounds_To_Sand 
	change THUGPRO_Footstep_Sounds_Changed = 1 
	change SFX_FootStepWalk01 = AU_SANDSTEP01 
	change SFX_FootStepWalk02 = AU_SANDSTEP02 
	change SFX_FootStepWalk03 = AU_SANDSTEP03 
	change SFX_FootStepRun01 = AU_SANDSTEP01 
	change SFX_FootStepRun02 = AU_SANDSTEP02 
	change SFX_FootStepRun03 = AU_SANDSTEP03 
	change SFX_FootStepRun04 = AU_SANDSTEP01 
	change SFX_FootStepRun05 = AU_SANDSTEP02 
ENDSCRIPT

SCRIPT SFX_Change_Footstep_Sounds_To_Water 
	change THUGPRO_Footstep_Sounds_Changed = 1 
	change SFX_FootStepWalk01 = landWater 
	change SFX_FootStepWalk02 = olliewater 
	change SFX_FootStepWalk03 = landWater 
	change SFX_FootStepRun01 = landWater 
	change SFX_FootStepRun02 = olliewater 
	change SFX_FootStepRun03 = landWater 
	change SFX_FootStepRun04 = olliewater 
	change SFX_FootStepRun05 = landWater 
ENDSCRIPT
...
SCRIPT ALL_SFX_Wait_Before_Tantrum_Stream 
	...
	IF SkaterIsNamed skater_shrek 
		PlaySkaterStream type = "tantrum_" 
	ELSE 
		PlaySkaterStream type = "tantrum" 
	ENDIF 
ENDSCRIPT

SCRIPT play_hoverboard_SFX pitch = 110 vol = 60 
	IF NOT IsSoundPlaying HoverboardRevertSound 
		Obj_PlaySound SK6_SE_DoorsOpen pitch = <pitch> vol = <vol> id = HoverboardRevertSound 
	ENDIF 
ENDSCRIPT
