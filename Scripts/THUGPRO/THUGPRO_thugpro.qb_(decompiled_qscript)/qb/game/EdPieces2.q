...
SCRIPT ParkEd_GetResourceValue 
	...
	IF NOT StructureContains ( <key> ) structure = ( Ed_Resources_Info ) 
		printf "~~~~~~~~ ParkEd_GetResourceValue: Bad key! Returning <size>=0 for <%s>" s = <key> 
		RETURN 
	ENDIF 
	GetPlatform 
	SWITCH <Platform> 
...
Ed_piece_sets = [ 
	...
	{ 
		name = "RISERS HUGE" 
		first = Sk3Ed_Ru1b_10x10x05 
	} 
	{ 
		name = "BLOCKS" 
		first = sk5ed_Matttest 
	} 
	{ 
		name = "THUGPRO MISC" 
		first = BO_ParkBench01 
	} 
] 
Ed_standard_metapieces = [ 
	...
	{ 
		multiple = [ 
			{ Sk3Ed_Fd1_10x10 [ 0 0 0 ] } 
			{ Sk3Ed_Fd1_10x10 [ 1 0 1 ] } 
			{ Sk3Ed_Fd1_10x10 [ 0 0 1 ] } 
			{ Sk3Ed_Fd1_10x10 [ 1 0 0 ] } 
		] 
