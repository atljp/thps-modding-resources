...
SCRIPT CutsceneFadeIn time = 0.00000000000 
	IF IsTrue output_cutscene_video 
		printf "Disabling fades with output_cutscene_video option" 
		RETURN 
	ENDIF 
...
SCRIPT CutsceneStartVideo 
	...
	SWITCH ( current_screen_mode ) 
		...
		CASE %"16_10_screen_mode" 
			change last_screen_mode = %"16_10_screen_mode" 
...
SCRIPT PostCutscene 
	...
	thugpro_set_cam_fov value = ( camera_fov_value ) 
ENDSCRIPT
...
SCRIPT cutscene_fake_letterboxing 
	...
	ENDIF 
	IF GotParam remove 
		SetScreen angle = 72.00000000000 aspect = 1.33333301544 
		RETURN 
	ELSE 
		SetScreen angle = 88.18000030518 aspect = 1.33333301544 
	ENDIF 
	SetScreenElementLock id = root_window off 
	CreateScreenElement { 
		type = ContainerElement 
