...
SkaterAnimEventTable = { 
	...
	grindnbarf_init = [ 
		{ time = 1.00000000000 event = GenericParticles params = { specialtrick_particles = barf_particles bone = Bone_head dont_orient_toskater = 1 StopEmitAt = 0.20000000298 } } 
	] 
	primohandstand_init = [ 
	...
	startskating1 = [ 
		{ time = 0.00000000000 event = TurnoffSkaterLoopingSound } 
		{ time = 0.34999999404 event = FootstepRunSoundEffect } 
		{ time = 0.34999999404 event = FootstepParticlesL } 
		{ time = 0.69999998808 event = FootstepRunSoundEffect } 
		{ time = 0.69999998808 event = FootstepParticlesR } 
		{ time = 0.89999997616 event = TurnOnSkaterLoopingSound } 
		{ time = 0.89999997616 event = SoundEffect params = { name = FlipTransitionDown01 } } 
	] 
	dropin = [ 
		{ time = 0.40000000596 event = CatchBoardSound params = { DefVol = 50 } } 
	...
	FS_PowerSlide_Init = [ 
		{ time = 0.00000000000 event = ReverSoundEffect params = { name = RevertConc DefPitch = 60 DefVol = 80 } } 
	] 
	BS_PowerSlide_Init = [ 
		{ time = 0.00000000000 event = ReverSoundEffect params = { name = RevertConc DefPitch = 60 DefVol = 80 } } 
	] 
	...
	flames_init = [ 
		{ time = 0.10000000149 event = GenericParticles params = { specialtrick_particles = firebreath_particles bone = Bone_head StopEmitAt = 0.40000000596 } } 
...
ActualSkaterAnimHandlerExceptionTable = [ 
	...
	{ event ex = ReverSoundEffect scr = HandleReverSoundEffectEvent } 
	...
	{ event ex = IronParticles scr = IronParticles_emitfromHand } 
...
SCRIPT HandleReverSoundEffectEvent { DefVol = 100 DefPitch = 100 } 
	GetBoardTypeAndRevert no_sound 
...
SCRIPT HandleLightning r = 200 g = 200 b = 255 
	...
	IF NOT InSplitScreenGame 
		TP_DoFlash { duration = 0.64999997616 
			additive 
...
doublefistin_doublecanon = 0 
SCRIPT HandleDoubleCanOn 
	IF ( Toggle_Special_item = 0 ) 
		change doublefistin_doublecanon = 1 
...
SCRIPT HandleDoubleCanOff 
	change doublefistin_doublecanon = 0 
...
SCRIPT HandleWhooshSoundEffect 
	Obj_PlaySound Whoosh pitch = RANDOM_RANGE PAIR(100.00000000000, 150.00000000000) vol = RANDOM_RANGE PAIR(40.00000000000, 70.00000000000) 
ENDSCRIPT

SCRIPT HandleFastWhooshSoundEffect 
	Obj_PlaySound Whoosh pitch = RANDOM_RANGE PAIR(150.00000000000, 200.00000000000) vol = RANDOM_RANGE PAIR(30.00000000000, 50.00000000000) 
ENDSCRIPT
