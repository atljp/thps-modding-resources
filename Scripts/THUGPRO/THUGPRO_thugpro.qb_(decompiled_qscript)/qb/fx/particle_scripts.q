...
SCRIPT alloc_fast_particle groupID = 0 
	...
	ENDIF 
	IF StructureContains structure = <params_script> Radii 
		<Radii> = ( <params_script> . Radii ) 
		StartRadius = ( <Radii> . VECTOR(1.00000000000, 0.00000000000, 0.00000000000) ) 
		MidRadius = ( <Radii> . VECTOR(0.00000000000, 1.00000000000, 0.00000000000) ) 
		EndRadius = ( <Radii> . VECTOR(0.00000000000, 0.00000000000, 1.00000000000) ) 
	ENDIF 
	IF StructureContains structure = <params_script> RadiusSpreads 
		<RadiusSpreads> = ( <params_script> . RadiusSpreads ) 
		StartRadiusSpread = ( <RadiusSpreads> . VECTOR(1.00000000000, 0.00000000000, 0.00000000000) ) 
		MidRadiusSpread = ( <RadiusSpreads> . VECTOR(0.00000000000, 1.00000000000, 0.00000000000) ) 
		EndRadiusSpread = ( <RadiusSpreads> . VECTOR(0.00000000000, 0.00000000000, 1.00000000000) ) 
	ENDIF 
	IF NOT ObjectExists id = <name> 
		IF gotparam attachObjId 
			IF StructureContains structure = <params_script> SuspendDistance 
