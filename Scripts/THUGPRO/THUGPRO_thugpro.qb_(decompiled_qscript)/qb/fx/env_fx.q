...
SCRIPT DisableSun 
	...
	MaybeHideLensFlare 
	DoScreenElementMorph id = Lens_Flare_Container scale = 0.00000000000 time = 0.50000000000 
	SetSunProps size = 0 
ENDSCRIPT

SCRIPT ShowLensFlare 
ENDSCRIPT

SCRIPT EnableSun 
	change DoUpdateLensFlare = 1 
	MaybeShowLensFlare 
	DoScreenElementMorph id = Lens_Flare_Container scale = 1.00000000000 time = 0.50000000000 
	SetSunProps size = 2132.00000000000 
ENDSCRIPT

SCRIPT MaybeShowLensFlare morph_time = 0.00000000000 
