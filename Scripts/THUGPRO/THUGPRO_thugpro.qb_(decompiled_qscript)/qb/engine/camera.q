...
SCRIPT screen_setup_standard 
	SetScreen Aspect = 1.33333301544 Angle = camera_fov letterbox = 0 
...
SCRIPT screen_setup_widescreen 
	SetScreen Aspect = 1.77777802944 Angle = widescreen_camera_fov letterbox = 0 
	IF GotParam set_screen_flags 
...
SCRIPT screen_setup_16_10 
	SetScreen Aspect = 1.60000002384 Angle = widescreen_camera_fov letterbox = 0 
	IF GotParam set_screen_flags 
		UnSetGlobalFlag flag = SCREEN_MODE_STANDARD 
		SetGlobalFlag flag = SCREEN_MODE_WIDE 
	ENDIF 
	change current_screen_mode = %"16_10_screen_mode" 
ENDSCRIPT

SCRIPT screen_setup_letterbox 
	SetScreen Aspect = 1.77777802944 Angle = widescreen_camera_fov letterbox = 1 
	IF GotParam set_screen_flags 
		SetGlobalFlag flag = SCREEN_MODE_STANDARD 
		SetGlobalFlag flag = SCREEN_MODE_WIDE 
	ENDIF 
