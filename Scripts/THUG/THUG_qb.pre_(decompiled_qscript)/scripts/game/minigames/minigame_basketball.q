...
SCRIPT Update_ShotCounter 
	...
	Create_panel_message id = Shotcounter pos = PAIR(80.00000000000, 240.00000000000) text = <Baskets_scored> 
ENDSCRIPT

SCRIPT Trick_MakeShot 
	Create_panel_message text = " " id = bball time = 1 
	Wait 1 Frame 
	Create_panel_message rgba = [ 32 144 32 100 ] pos = PAIR(320.00000000000, 80.00000000000) id = bball RANDOM(1, 1, 1, 1, 1) RANDOMCASE text = "Nice!" RANDOMCASE text = "He shoots he scores!" RANDOMCASE text = "Bucket!" RANDOMCASE text = "Nice!" RANDOMCASE text = "Swish!" RANDOMEND 
ENDSCRIPT

SCRIPT Trick_MissShot 
	Create_panel_message text = " " id = bball time = 1 
	Wait 1 Frame 
	Create_panel_message id = bball pos = PAIR(320.00000000000, 80.00000000000) RANDOM(1, 1, 1, 1) RANDOMCASE text = "Airball!" RANDOMCASE text = "CLANG!" RANDOMCASE text = "Weak..." RANDOMCASE text = "Brick!" RANDOMEND 
ENDSCRIPT

SCRIPT Trick_DidNotShoot 
	Create_panel_message text = " " id = bball time = 1 
	Wait 1 Frame 
	Create_panel_message id = bball pos = PAIR(320.00000000000, 80.00000000000) text = "Release X to shoot, moron!" 
ENDSCRIPT
...
SCRIPT Sch_MG_BBallShootCheck 
	...
	BEGIN 
		Obj_MoveToRelPos VECTOR(0.00000000000, 5.00000000000, 0.00000000000) 
		Wait 1 Frame 
