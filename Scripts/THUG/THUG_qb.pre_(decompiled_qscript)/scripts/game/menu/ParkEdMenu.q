...
SCRIPT parked_make_piece_menu { 
	...
	build_theme_box_icons just_top icon_texture = <paused_icon> parent = piece_menu_container pos = PAIR(550.00000000000, -5.00000000000) scale = PAIR(1.79999995232, 2.29999995232) 
	build_grunge_piece parent = piece_menu_container rgba = [ 128 128 128 128 ] 
	build_top_bar scale = PAIR(1.48000001907, 1.50000000000) pos = PAIR(230.00000000000, 73.00000000000) parent = piece_menu_container 
	CreateScreenElement { 
		type = SpriteElement 
		parent = piece_menu_container 
		id = right_bracket2 
		pos = PAIR(575.00000000000, 123.00000000000) 
		texture = generic_sub_frame 
		rgba = [ 128 128 128 128 ] 
		scale = PAIR(1.50000000000, 1.10000002384) 
		alpha = 0.80000001192 
		z_priority = 1 
		rot_angle = 180 
	} 
