...
SCRIPT create_existing_goals_menu 
	...
	IF ( <num_lines> > 8 ) 
		num_lines = 8 
	ENDIF 
	make_new_themed_scrolling_menu title = "CREATED GOALS" title_icon = <title_icon> dims = ( PAIR(300.00000000000, 0.00000000000) + PAIR(0.00000000000, 1.00000000000) * 23 * <num_lines> ) 
