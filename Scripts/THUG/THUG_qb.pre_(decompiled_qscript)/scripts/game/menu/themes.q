...
SCRIPT swap_themes_menu 
	...
	IF LevelIs load_skateshop 
		...
		CreateScreenElement { 
			...
			texture = <menu_title> 
			just = [ center center ] 
			pos = PAIR(460.00000000000, 240.00000000000) 
			scale = 1.29999995232 
			rot_angle = -12 
			z_priority = 1 
			alpha = 0.30000001192 
		...
		CreateScreenElement { 
			...
			texture = <main_icon> 
			just = [ center center ] 
			pos = PAIR(460.00000000000, 200.00000000000) 
			scale = 3.00000000000 
			rot_angle = -12 
			z_priority = 1 
			alpha = 0.30000001192 
	...
	common_params = { pad_choose_script = set_current_theme centered = 1 no_bg = no_bg highlight_bar_scale = PAIR(2.29999995232, 0.69999998808) } 
