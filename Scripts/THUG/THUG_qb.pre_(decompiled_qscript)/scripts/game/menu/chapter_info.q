...
CHAPTER_GOALS = [ 
	...
	[ 
		[ 
			...
			{ text = "Impress Joey" goal_id = nj_goal_trickspot6 no_ped_cam = no_ped_cam targetOffset = VECTOR(-61.48307800293, 19.80982398987, 2241.03784179688) positionOffset = VECTOR(-54.83562469482, 21.69812583923, 2240.75048828125) } 
			{ text = "Do Chris\' Best Lines" goal_id = nj_goal_race3 no_ped_cam = no_ped_cam targetOffset = VECTOR(-2671.17651367188, 99.13886260986, 2742.92065429688) positionOffset = VECTOR(-2659.80102539062, 78.29908752441, 2773.37426757812) } 
		] 
	...
	[ 
		[ 
			{ text = "Help Stacy\'s relative" goal_id = NY_Goal_GenericScore6 no_ped_cam = no_ped_cam targetOffset = VECTOR(-3579.07299804688, 61.08202362061, -4978.12988281250) positionOffset = VECTOR(-3579.73657226562, 59.38602066040, -4962.23779296875) } 
	...
	[ 
		[ 
			{ text = "Party boat Skate-Tricks" goal_id = FL_Goal_Tetris no_ped_cam = no_ped_cam targetOffset = VECTOR(3950.10961914062, 89.72080230713, 4601.57031250000) positionOffset = VECTOR(4110.02392578125, 3.50602293015, 4738.77148437500) } 
			{ text = "Wallplant Combo" goal_id = FL_Goal_Gaps no_ped_cam = no_ped_cam targetOffset = VECTOR(5021.47509765625, 253.92591857910, -1781.83105468750) positionOffset = VECTOR(5261.79980468750, 255.69186401367, -1783.79492187500) } 
	...
	[ 
		[ 
			...
			{ text = "Wallows combo bowls" goal_id = HI_Goal_Trickspot2 no_ped_cam = no_ped_cam targetOffset = VECTOR(-698.98760986328, -96.81425476074, -5766.19335937500) positionOffset = VECTOR(-828.28808593750, 5.86229276657, -5488.19482421875) } 
		...
		[ 
			{ text = "Climb the Hotel" final goal_id = HI_Goal_Trickspot no_ped_cam = no_ped_cam targetOffset = VECTOR(-698.98760986328, -96.81425476074, -5766.19335937500) positionOffset = VECTOR(204.38563537598, 71.19428253174, 808.88519287109) } 
		] 
	] 
	[ 
		[ 
		...
		[ 
			{ text = "Craziest Footage ever" final goal_id = HI_Goal_GenericScore no_ped_cam = no_ped_cam targetOffset = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) positionOffset = VECTOR(715.81268310547, 1578.23400878906, 1303.22717285156) } 
		] 
	] 
	[ 
		[ 
			...
			{ text = "Bust some Flatland" goal_id = VC_Goal_tetris no_ped_cam = no_ped_cam targetOffset = VECTOR(3544.23510742188, -101.28214263916, 3230.42407226562) positionOffset = VECTOR(3376.24755859375, -100.68465423584, 3225.95312500000) } 
			{ text = "Race the Blowcart" goal_id = VC_Goal_Race2 } 
			{ text = "Party dregs" goal_id = VC_Goal_Collect2 } 
			{ text = "Slam City Fan" goal_id = VC_Goal_Collect3 no_ped_cam = no_ped_cam targetOffset = VECTOR(5236.55078125000, 269.43624877930, -2739.85791015625) positionOffset = VECTOR(5380.48388671875, 318.54779052734, -2272.21752929688) } 
			{ text = "Ralphie got busted" goal_id = VC_Goal_Race no_ped_cam = no_ped_cam targetOffset = VECTOR(3667.59887695312, 149.48593139648, 1785.01184082031) positionOffset = VECTOR(3669.56518554688, 147.34617614746, 1784.60351562500) } 
	...
	[ 
		[ 
			...
			{ text = "Destroy the Vert Contest" goal_id = SJ_Goal_Comp no_ped_cam = no_ped_cam targetOffset = VECTOR(-2232.44873046875, -234.96044921875, -226.10220336914) positionOffset = VECTOR(-1799.22985839844, -1249.16162109375, -17.24891662598) } 
	...
	[ 
		[ 
			{ text = "Serve the people" goal_id = RU_Goal_Tetris2 no_ped_cam = no_ped_cam targetOffset = VECTOR(3950.10961914062, 89.72080230713, 4601.57031250000) positionOffset = VECTOR(4110.02392578125, 170.50602722168, 4738.77148437500) } 
			{ text = "Blind Big Brother" goal_id = RU_Goal_race2 } 
			{ text = "Ready for Battle" goal_id = RU_Goal_trickspot no_ped_cam = no_ped_cam targetOffset = VECTOR(3950.10961914062, 89.72080230713, 4601.57031250000) positionOffset = VECTOR(-1619.00769042969, 27.39734649658, -413.56878662109) } 
		] 
		[ 
	...
	[ 
		[ 
			{ text = "Anonymous caller" goal_id = RU_Goal_race3 no_ped_cam = no_ped_cam targetOffset = VECTOR(1099.66638183594, -102.66417694092, 2106.47167968750) positionOffset = VECTOR(1304.35278320312, -20.62909698486, 3007.78125000000) } 
			{ text = "Party Favors" goal_id = RU_Goal_Race6 } 
			{ text = "Hangover Cure" goal_id = RU_Goal_Race5 no_ped_cam = no_ped_cam targetOffset = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) positionOffset = VECTOR(-1359.08557128906, 517.37927246094, -3747.73901367188) } 
		] 
		[ 
	...
	[ 
		[ 
			...
			{ text = "Score Big" goal_id = nj_goal_GenericScore4 no_ped_cam = no_ped_cam targetOffset = VECTOR(0.00000000000, 0.00000000000, 0.00000000000) positionOffset = VECTOR(-3945.86669921875, 97.83377075195, 2937.32885742188) } 
		] 
	] 
	[ 
		[ 
...
SCRIPT NJ_StageSwitch_3_1_to_3_2 
	WeatherSetRainRate 0.00000000000 
...
SCRIPT NJ_StageSwitch_3_1_to_3_2_Spawned 
	start_dynamic_tod tod_start = set_tod_nj_morning tod_end = set_tod_day tod_speed = 0.05999999866 dontchangelights = 1 
	IF GotParam just_won_goal 
...
SCRIPT NJ_StageSwitch_3_2_to_3_3 
	...
	EnableFog 
	start_dynamic_tod tod_start = set_tod_day tod_end = set_tod_nj_evening tod_speed = 0.05999999866 dontchangelights = 1 
...
SCRIPT Sponsor_Challenge_Pre_Movie_Info 
	...
	create_dialog_box { title = "Congrats: You\'re an Am!" 
		...
		text_dims = PAIR(340.00000000000, 0.00000000000) 
	} 
ENDSCRIPT
