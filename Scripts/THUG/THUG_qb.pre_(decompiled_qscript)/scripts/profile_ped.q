...
Ped_Kid_Skateboard_a = { 
	...
	ped_m_legs = { randomized_desc_id } 
	ped_board = { desc_id = Skateboard } 
	scale = VECTOR(0.75000000000, 0.64999997616, 0.89999997616) 
...
Ped_Drugdealer_02 = { 
	...
	scale = VECTOR(0.89999997616, 1.12999999523, 0.89999997616) 
} 
Ped_Drugdealer_03 = { 
...
Ped_Tombstone = { 
	...
	scale = VECTOR(1.10000002384, 0.89999997616, 0.89999997616) 
} 
...
Ped_FratGuy_a = { 
	...
	scale = VECTOR(1.00000000000, 0.94999998808, 1.00000000000) 
...
Ped_FratGuy_b = { 
	...
	ped_m_torso = { desc_id = Torso_Fratshirt01 } 
	ped_m_legs = { desc_id = Legs03 } 
	scale = VECTOR(1.20000004768, 1.10000002384, 1.20000004768) 
} 
Ped_Basketball_b = { 
	ped_body = { desc_id = BBall02 } 
	ped_board = { desc_id = basketball } 
	scale = VECTOR(0.89999997616, 1.10000002384, 1.00000000000) 
} 
Ped_Basketball_c = { 
	ped_m_head = { desc_id = Head_Bald01 } 
	ped_m_torso = { desc_id = Torso_Bball01 } 
	ped_m_legs = { desc_id = Legs03 } 
	scale = VECTOR(1.29999995232, 0.94999998808, 1.29999995232) 
} 
Ped_Basketball_d = { 
...
Ped_Kid_grommit_a = { 
	...
	ped_board = { desc_id = Skateboard } 
	scale = VECTOR(0.89999997616, 0.80000001192, 0.89999997616) 
} 
Ped_Jogger_Female_a = { 
} 
Ped_Kid_grommit_b = { 
...
Ped_Stroller_a = { 
	...
	scale = VECTOR(0.89999997616, 1.00000000000, 1.00000000000) 
	body_shape = stroller_scale_info 
} 
Ped_Zooemployee_b = { 
...
Ped_Kid_Balloon_a = { 
	...
	scale = VECTOR(0.60000002384, 0.50000000000, 0.69999998808) 
